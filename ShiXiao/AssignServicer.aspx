<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AssignServicer.aspx.cs" Inherits="ShiXiao_AssignServicer" %>
...
<form name="form1"  runat="server" id="form1">
	<div class="Body_Title">
            ...
            <div>
               客户名称或者录入人或客服人员: <asp:TextBox ID="TextBox1" runat="server"></asp:TextBox>
                <asp:Button ID="Button3" runat="server" Text="查询客户" onclick="Button3_Click" />
                <span style ="color :Red ">||</span>
将列表所选人
<asp:Button ID="Button1" runat="server" class="BnCss" Text="确定指定给" OnClick="Button1_Click1" /><asp:DropDownList ID="response" runat="server">
</asp:DropDownList>
<asp:Button ID="Button2" runat="server" Visible="false" class="BnCss" Text="跳至取消"
    OnClick="Button2_Click1" />
    
                <asp:GridView ID="GridView1" runat="server" Width="100%" AutoGenerateColumns="False"
        DataKeyNames="kehuid" OnRowDataBound="GridView1_RowDataBound" OnRowDeleting="GridView1_RowDeleting"
        ...
        OnRowUpdating="GridView1_RowUpdating" CssClass="Admin_Table">
                    ...
                    <asp:BoundField DataField="providername" HeaderText="当前客服" />
