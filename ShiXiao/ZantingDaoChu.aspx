<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ZantingDaoChu.aspx.cs" Inherits="ShiXiao_ZantingDaoChu" %>
            ...
            <tr bgcolor="#f4faff">
                <td style="height: 5px">
                    <asp:DropDownList ID="DropDownList1" runat="server" Width="77px">
                        ...
                        <asp:ListItem Value="st1">报告状态</asp:ListItem>
                    </asp:DropDownList>
                    ...
                    <asp:Button ID="Button2" runat="server" CssClass="BnCss" OnClick="Button2_Click"
                        Text="查询" /><asp:Button ID="Button1" runat="server" OnClick="Button1_Click" Text="导出excel" />
                </td>
            </tr>
            <tr bgcolor="#f4faff">
                <td style="height: 5px">
                    ...
                    <ItemTemplate>
                        <a href="javascript:expandcollapse('div<%# Eval("rwbianhao") %>', 'one');">
                            ...
                            <asp:BoundField DataField="day2" HeaderText="总共" Visible ="false" />
                            ...
                            <asp:HyperLinkField HeaderText="资料" Text="资料" Visible ="false"  Target="_blank" DataNavigateUrlFormatString="~/Case/ziliaoaddm.aspx?xiangmuid={0}"
                                                        ...
                                                        <asp:GridView ID="GridView2" BackColor="White" Width="100%" CssClass="Admin_Table" AutoGenerateColumns="false"
                                                           ...
                                                           >
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <asp:BoundField DataField="time2" DataFormatString ="{0:d}" HeaderText="操作日期"></asp:BoundField>
