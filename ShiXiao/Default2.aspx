<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Default2.aspx.cs" Inherits="ShiXiao_Default2" %>
...
<body>
    ...
    <div>
        <div class="Body_Title">
            工程管理 》》已分派工程师但还未接收的任务(是否超期目前根据完成日期来判定,另外，如果在查询结果后要选择排序标准，请在选择排序标准后重新点击查询。)</div>
            ...
            <tr bgcolor="#f4faff">
                ...
                DataNavigateUrlFields="rwbianhao" />
                            ...
                            <asp:HyperLinkField HeaderText="查看" Text="查看" Target="_blank" DataNavigateUrlFormatString="~/Case/Tasksee.aspx?tijiaobianhao={0}&&chakan=0"
                                DataNavigateUrlFields="bianhao" />
                            <asp:HyperLinkField HeaderText="上报" Text="上报" Target="_blank" DataNavigateUrlFormatString="~/Case/CeShiFeiGc.aspx?bianhao={0}"
                                DataNavigateUrlFields="bianhao" />
                            <asp:TemplateField HeaderText="参与">
                             ...
                             <asp:TemplateField HeaderText="接收">
                                <ItemTemplate>
                                    <asp:LinkButton ID="LinkButton7" runat="server" Text="接收" CommandArgument='<%# Eval("rwbianhao") %>'
