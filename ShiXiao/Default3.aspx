<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Default3.aspx.cs" Inherits="ShiXiao_Default3" %>
...
<body>
                ...
                <td style="height: 5px">
                    <asp:GridView ID="GridView1" runat="server" Width="100%" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="b7" HeaderText="申请日期"  />
                            <asp:BoundField DataField="b8" HeaderText="申请原因" />
                           ...
                           <asp:BoundField DataField="b2" HeaderText="申请暂停" />
                            <asp:HyperLinkField HeaderText="操作" Text="分派" Target="_blank" DataNavigateUrlFormatString="~/Case/FenPaiKeFu.aspx?xiangmuid={0}"
                 ...
                 <asp:TemplateField HeaderText="操作"  >
                    <ItemTemplate>
                        <asp:LinkButton ID="LinkButton51" runat="server" Text="取消申请" CommandArgument='<%# Eval("rwbianhao") %>'
    ...
    <asp:Label runat="server" ID="lb2"></asp:Label>
        ...
        <ContentTemplate>
            ...
            <cc1:popupwin id="pw" Title ="备注提示" runat="server" ShowAfter ="0" HideAfter ="100000" style="left: 63px; top: 99px" 
                DragDrop="False"  ActionType ="OpenLink"  Link="TaskBeiZhu.aspx"  LinkTarget="_blank"   Height="109px" 
                Width="214px" Message ="" AutoShow="true"> </cc1:popupwin>
        </ContentTemplate>  
        </asp:UpdatePanel>
