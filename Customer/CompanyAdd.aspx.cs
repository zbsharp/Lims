...
public partial class Customer_CompanyAdd : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        con.Open();
            ...
            string sql = "insert into CompanyManage values('" + TextBox1.Text + "','" + TextBox2.Text + "','" + TextBox3.Text + "','" + TextBox4.Text + "','" + TextBox5.Text + "','" + TextBox6.Text + "','" + Session["username"].ToString() + "','" + DateTime.Now + "','','','')";
    ...
    protected void bind()
    {
        SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings["DB"].ConnectionString);
        con.Open();
        string sql1 = "select * from CompanyManage where CompanyId='"+kehuid+"'";
    ...
    protected void GridView1_RowDeleting(object sender, GridViewDeleteEventArgs e)
    {
        ...
        {
            dr2.Close();
            string sql = "delete from CompanyManage where id=" + Appurtenanceid + " and fillname='"+Session["UserName"].ToString()+"'";
