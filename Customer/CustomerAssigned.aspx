<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CustomerAssigned.aspx.cs"
    Inherits="Customer_CustomerAssigned" %>
...
<body>
    ...
    <asp:DropDownList ID="DropDownList3" runat="server" Visible ="false" >
        <asp:ListItem>分配时间</asp:ListItem>
        <asp:ListItem>跟踪设定时间</asp:ListItem>
    </asp:DropDownList>
  <input id="txFDate" name="txFDate" class="TxCss" type="text" visible ="false"  value="" onclick="popUpCalendar(this,document.forms[0].txFDate,'yyyy-mm-dd')"
        readonly runat="server" style="width: 68px" />
    
    <input id="txTDate" name="txTDate" class="TxCss" type="text" value="" visible ="false" onclick="popUpCalendar(this,document.forms[0].txTDate,'yyyy-mm-dd')"
        readonly runat="server" style="width: 69px" />客户名称或业务员<asp:DropDownList ID="DropDownList1"
    ...
    <input id="Button7" onclick="jizhuangxiang2()" type="button" class="BnCss" style ="display :none" value="业务员"
        visible="false" />
    <asp:Button ID="Button1" runat="server" class="BnCss" Text="确定分派给" OnClick="Button1_Click1" />
    ...
    <asp:DropDownList
        ...
        <asp:ListItem>加派</asp:ListItem>
        <asp:ListItem>改派</asp:ListItem>
        ...
        <asp:UpdatePanel ID="UpdatePanel2" runat="server" UpdateMode="Conditional">
            <ContentTemplate>
                ...
                <asp:GridView ID="GridView1" runat="server" Width="100%" CssClass="Admin_Table" AutoGenerateColumns="false"
                    DataKeyNames="kehuid" OnRowDataBound="GridView1_RowDataBound" OnRowCommand="GridView1_RowCommand">
                    <Columns>
                        <asp:TemplateField>
                            <HeaderTemplate>
                                全选
                        ...
                        <asp:BoundField DataField="xingyongdengji" HeaderText="信用" />
                        <asp:BoundField DataField="responser" HeaderText="业务员" />
                        <asp:BoundField DataField="pubtime2" HeaderText="分配时间" DataFormatString="{0:d}"  />
                        <asp:BoundField DataField="customlevel" HeaderText="请求分派" />
                        <asp:TemplateField>
                            <ItemTemplate>
                                <asp:LinkButton ID="LinkButton3" runat="server" CommandName="Share" CommandArgument='<%#DataBinder.Eval(Container.DataItem, "ID")%>'>取消</asp:LinkButton>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField>
                            <ItemTemplate>
                                <asp:LinkButton ID="LinkButton9" runat="server" CommandName="Share1" CommandArgument='<%#DataBinder.Eval(Container.DataItem, "kehuid")%>'>查看客户</asp:LinkButton>
                            </ItemTemplate>
                        </asp:TemplateField>
