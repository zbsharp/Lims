...
using Common;
public partial class Customer_CustomerAssign : System.Web.UI.Page
{
    #region 初始绑定
    ...
    public void Bind()
    {
        ...
        sql = "select *   from Customer where  (customname  like('%" + TextBox1.Text + "%') or responser like('%" + TextBox1.Text + "%')) and b='否' and " + searchwhere.search(Session["UserName"].ToString()) + " order by filltime desc";
