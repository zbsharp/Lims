<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CustomerAssign.aspx.cs" Inherits="Customer_CustomerAssign" %>
...
-->
    ...
    <link href="../Images/chysoft.css" rel="stylesheet" type="text/css" />
    <link href="../Web_CSS/WebCss.css" rel="stylesheet" type="text/css" />
...
<body>
 ...
 <%--   <div class="Body_Title">
  ...
  <TBODY>
  <TR>
    <TD id=right_title colSpan=2>
      <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
        <TBODY>
        <TR>
          <TD width="3%"><IMG height=30 
            src="../images/index_tilte_icon.jpg" width=31></TD>
          <TD class=font_index_tilte>销售管理 》》客户信息</TD></TR></TBODY></TABLE></TD></TR>
 
 
  <TR>
    <TD class=list_table colSpan=2>
      <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
        <TBODY>
        <TR>
          <TD class=right_ss>
  ...
  <TR>
    <TD id=right_title colSpan=2>
      <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
        <TR>
          <TD width="3%"><IMG height=30 src="../images/index_tilte_icon.jpg" width=31></TD>
          <TD width="94%">
            <table width="100%" border="0" class="table_index_right" cellspacing="0" cellpadding="0">
             <tr>
                <td class="font_index_tilte" width="120">
                  实时考勤状态表
                </td>
                <td width="*" valign="bottom">正常(O)&nbsp;迟到(<font color=#FF5050>L</font>)&nbsp;早退(<font color=#FF5050>E</font>)&nbsp;未打卡(<font color=#FF5050>N</font>)&nbsp;出差(<font color=blue>C</font>)&nbsp;公干(<font color=blue>G</font>)&nbsp;请假(<font color=blue>H</font>)
                (如:“<font color=#FF5050>L</font><font color=#FF5050>N</font>”表示上班迟到/下班未打卡,“<font color=#FF5050>NN</font>”表示上下班都未打卡)</td>
            </tr>
          </table>
          </TD>
        </TR>
