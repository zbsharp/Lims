<%@ Page Language="C#" AutoEventWireup="true" CodeFile="XieYiList.aspx.cs" Inherits="Customer_XieYiList" %>
...
<body>
    ...
    <div class="div_All">
        ...
        <table align="center" border="0" cellpadding="3" cellspacing="1" style="background-color: #b9d8f3"
            ...
            <tr bgcolor="#f4faff">
                <td style="height: 5px">
                    签署时间：<input id="txFDate" runat="server" class="TxCss" name="txFDate" onclick="popUpCalendar(this,document.forms[0].txFDate,'yyyy-mm-dd')"
                    ...
                    <asp:GridView ID="GridView1" runat="server" Width="100%" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="CompanyId" HeaderText="企业编号" />
                             <asp:BoundField DataField="kh" HeaderText="企业名称" />
