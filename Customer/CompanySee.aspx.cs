...
public partial class Customer_CompanySee : System.Web.UI.Page
{
    protected string id = "";
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string sql3 = "select * from CompanyManage where id='" + id + "'";
        ...
        if (!IsPostBack)
        {
            ...
            string sql = "select * from CompanyManage where id='" + id + "'";
    ...
    public void BindFujian()
    {
        SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings["DB"].ConnectionString);
        con.Open();
        string sql1 = "select * from xieyifujian where  baojiaid='" + kehuid + "' and baojiaid !=''";
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            string sql = "update CompanyManage set Title='" + TextBox2.Text + "',Detail='" + TextBox3.Text + "',Signdate='" + TextBox4.Text + "',Enddate='" + TextBox5.Text + "',remark='" + TextBox6.Text + "' where id='" + id + "'";
    ...
    protected void Button2_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            else
            {
                ...
                SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings["DB"].ConnectionString);
                con.Open();
                string sql = "insert xieyifujian values('" + kehuid + "','" + ImageUrl + "','" + fileName + "','" + type + "','" + Session["username"].ToString() + "','" + DateTime.Now + "','协议','" + kehuid + "','')";
                SqlCommand com = new SqlCommand(sql, con);
                com.ExecuteNonQuery();
                con.Close();
    ...
    protected void GridView2_RowDeleting(object sender, GridViewDeleteEventArgs e)
    {
        ...
        string sql3 = "select * from ModuleDuty where name='" + Session["UserName"].ToString() + "' and modulename='协议管理'";
        ...
        string sql = "delete from xieyifujian where id=" + Appurtenanceid + " and fillname='"+Session["UserName"].ToString()+"'";
        SqlCommand com = new SqlCommand(sql, con);
