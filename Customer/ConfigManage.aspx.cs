...
public partial class Customer_ConfigManage : System.Web.UI.Page
{
    ...
    protected void b1()
    {
        ...
        string sql = "select * from PersonConfig where name1='" + Session["UserName"].ToString() + "'";
    ...
    protected void b2()
    {
        ...
        string sql = "select * from PersonConfig where name2='" + Session["UserName"].ToString() + "' order by name1";
