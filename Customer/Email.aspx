<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Email.aspx.cs" Inherits="Customer_Email" %>
...
<body>
    ...
    <div class="div_All">
        ...
        <div>
            ...
            onclick="Button2_Click" Text="导出excel" />
        </div>
        ...
        <asp:GridView ID="GridView1" runat="server" Width="100%" CssClass="Admin_Table" onrowdatabound="GridView1_RowDataBound" AutoGenerateColumns="false">
            <Columns>
                ...
                <asp:TemplateField HeaderText="编号" SortExpression="customerid">
                    <ItemTemplate>
                        <asp:Label ID="Label1" runat="server" Text='<%# Eval("customerid") %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>

                 <asp:BoundField DataField="ctn"  HeaderText="客户名称" />
              ...
              <asp:BoundField DataField="telephone"  HeaderText="电话" />
               <asp:BoundField DataField="mobile"  HeaderText="手机" />
                ...
                <asp:HyperLinkField DataNavigateUrlFields="customerid" DataNavigateUrlFormatString="~/Customer/CustomerSee.aspx?kehuid={0}"
