<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Rollback.aspx.cs" Inherits="Customer_Rollback" %>
            ...
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" Width="100%" CssClass="Admin_Table" OnRowDataBound="GridView1_RowDataBound" OnRowCommand="GridView1_RowCommand">
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="操作">
                        <ItemTemplate>
                            <asp:LinkButton ID="LinkButton2" runat="server" CommandName="rollback" CommandArgument='<%# Eval("baojiaid")%>'>回退</asp:LinkButton>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:BoundField DataField="zhehoujia" HeaderText="zhehoujia" HeaderStyle-CssClass="money" ItemStyle-CssClass="money">
                        <HeaderStyle CssClass="money"></HeaderStyle>
