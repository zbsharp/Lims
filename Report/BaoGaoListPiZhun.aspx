<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BaoGaoListPiZhun.aspx.cs" Inherits="Report_BaoGaoListPiZhun" %>
                ...
                <tr bgcolor="#f4faff">
                    <td style="height: 5px">
                        ...
                        <asp:DropDownList ID="DropDownList2" runat="server">
                            ...
                            <asp:ListItem Value="已缮制">已缮制</asp:ListItem>
                            <asp:ListItem Value="已出草稿">未缮制</asp:ListItem>
                        </asp:DropDownList>
        ...
        <input id="txTDate" runat="server" class="TxCss" name="txTDate" onclick="new Calendar().show(this.form.txTDate);"
            style="width: 90px" type="text" visible="true" />
                        ...
                        <asp:Button ID="Button2" runat="server" CssClass="BnCss" OnClick="Button2_Click"
                            Text="查询" /><br />
                        <span>
                            <b>CMA：&nbsp;&nbsp;</b><asp:DropDownList ID="CMA" runat="server">
                        ...
                        <span>
                            <b>CNAS：</b>
                            <asp:DropDownList ID="CNAS" runat="server">
                                <asp:ListItem>否</asp:ListItem>
                                <asp:ListItem>是</asp:ListItem>
                            </asp:DropDownList>
                            &nbsp;&nbsp;&nbsp;&nbsp;
                        ...
                        <span>
                            <b>A2lA：</b>
                            <asp:DropDownList ID="AtwolA" runat="server">
                                <asp:ListItem>否</asp:ListItem>
                                <asp:ListItem>是</asp:ListItem>
                            </asp:DropDownList>
                        </span>
                        &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;签发时间：&nbsp;
                        <input id="shangzhi_time" runat="server" class="TxCss" name="shangzhi_time" onclick="new Calendar().show(this.form.shangzhi_time);" style="width: 90px" type="text" visible="true" />&nbsp;
                        <asp:Button ID="Button3" runat="server" Text="批量缮制" OnClick="Button3_Click" />
                    </td>
                </tr>
                <tr bgcolor="#f4faff">
                    <td style="height: 5px">
                        ...
                        <asp:GridView ID="GridView1" runat="server" Width="100%" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                ...
                                <asp:HyperLinkField HeaderText="草稿报告" Text="下载" Target="_blank" DataNavigateUrlFormatString="~/Report/BaoGaoFirstUpLoadShenHe2.aspx?baogaoid={0}"
                                ...
                                <asp:TemplateField HeaderText="操作">
                                    <ItemTemplate>
                                        <asp:LinkButton ID="LinkButton1" runat="server" CommandArgument='<%#Eval("id") %>' CommandName="shanzhi">缮制</asp:LinkButton>
                                    </ItemTemplate>
                                </asp:TemplateField>

                                <asp:HyperLinkField HeaderText="上传报告" Text="上传报告" Target="_blank" DataNavigateUrlFormatString="~/Report/BaoGaoShenPi2.aspx?baogaoid={0}"
                                    DataNavigateUrlFields="baogaoid" />
