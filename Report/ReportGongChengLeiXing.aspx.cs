...
public partial class Report_ReportGongChengLeiXing : System.Web.UI.Page
{
    private int _i = 0;
    ...
    protected void BindDep()
    {
        ...
        con3.Open();
        string sql = "select username from userinfo  where dutyname='工程师' order by username ";
    ...
    protected DataTable table(string a, string b)
    {
        ...
        string sql2 = "select * from UserChuCuo where  wenyuan in (select leirong from BaoGaoChaCuo  where convert(datetime,time) between '" + Convert.ToDateTime(a) + "' and '" + Convert.ToDateTime(b).AddHours(23) + "'  and gongchengshi='" + DropDownList1.SelectedValue + "') and  name in (select fenlei from BaoGaoChaCuo  where convert(datetime,time) between '" + Convert.ToDateTime(a) + "' and '" + Convert.ToDateTime(b).AddHours(23) + "'  and gongchengshi='" + DropDownList1.SelectedValue + "')  order by name";
        ...
        for (int yue = 0; yue < dtcount2; yue++)
        {
            ...
            string sql31 = "select count(*) as c1 from BaoGaoChaCuo where convert(datetime,time) between '" + Convert.ToDateTime(a) + "' and '" + Convert.ToDateTime(b).AddHours(23) + "' and leirong='" + ds2.Tables[0].Rows[yue]["wenyuan"].ToString() + "' and fenlei='" + ds2.Tables[0].Rows[yue]["name"].ToString() + "' and gongchengshi='" + DropDownList1.SelectedValue + "' group by leirong";
