...
public partial class Report_BaoGaoListQianZi : System.Web.UI.Page
{
    protected string shwhere = "1=1";
    private int _i = 0;
    const string vsKey = "searchbaogao1";
    protected void Page_Load(object sender, EventArgs e)
    {


        shwhere = "state ='打印完成' and (statebumen1 ='' or statebumen1='在签') ";
    ...
    protected void Button2_Click(object sender, EventArgs e)
    {
        ...
        {
            sqlstr = " select  *,(select shenqingbianhao from anjianxinxi2 where taskno=baogao2.tjid) as shenqingbianhao from BaoGao2  where " + shwhere + " and  " + ChooseNo + " like  '%" + ChooseValue + "%' and convert(datetime,filltime) between '" + Convert.ToDateTime(txFDate.Value.Trim()) + "' and '" + Convert.ToDateTime(txTDate.Value.Trim()).AddHours(23) + "'";
        }
    ...
    protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            e.Row.Cells[9].Text = sxb1.BaoGaoShiJian(f).ToString();
