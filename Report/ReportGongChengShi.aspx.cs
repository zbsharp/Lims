...
public partial class Report_ReportGongChengShi : System.Web.UI.Page
{
    private int _i = 0;
    ...
    protected DataTable table(string a, string b)
    {
        ...
        string sql2 = "select * from UserDepa where (departmentid='12' or departmentid='13' or departmentid='15' or departmentid='16' or departmentid='17' or departmentid='9') and name in (select bumen from BaoGaoChaCuo where convert(datetime,time) between '" + Convert.ToDateTime(a) + "' and '" + Convert.ToDateTime(b).AddHours(23) + "' ) order by name";
        ...
        for (int yue = 0; yue < dtcount2; yue++)
        {
            ...
            string sql31 = "select count(*) as c1 from BaoGaoChaCuo where convert(datetime,time) between '" + Convert.ToDateTime(a) + "' and '" + Convert.ToDateTime(b).AddHours(23) + "' and bumen='" + ds2.Tables[0].Rows[yue]["name"].ToString() + "' group by bumen";
