...
public partial class Report_ReportLeiXing1 : System.Web.UI.Page
{
    private int _i = 0;
    ...
    protected void BindDep()
    {
        ...
        string sql = "select wenyuan from UserChuCuo  where name='"+DropDownList2.SelectedValue+"'  order by name ";
        ...
        DropDownList1.DataValueField = "wenyuan";
        DropDownList1.DataTextField = "wenyuan";
    ...
    protected void DropDownList2_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        con.Open();
        string sql = "select * from UserChuCuo where name='" + DropDownList2.SelectedValue + "'  order by wenyuan asc ";
    ...
    protected DataTable table(string a, string b)
    {
        ...
        dt.Columns.Add("工程师", Type.GetType("System.String"));
        ...
        string sql2 = "select username from userinfo  where dutyid='4' and username in (select gongchengshi from BaoGaoChaCuo where convert(datetime,time) between '" + Convert.ToDateTime(a) + "' and '" + Convert.ToDateTime(b).AddHours(23) + "' and leirong='" + DropDownList1.SelectedValue + "' and fenlei='" + DropDownList2.SelectedValue + "') order by username";
        ...
        for (int yue = 0; yue < dtcount2; yue++)
        {
            ...
            string sql31 = "select count(*) as c1 from BaoGaoChaCuo where convert(datetime,time) between '" + Convert.ToDateTime(a) + "' and '" + Convert.ToDateTime(b).AddHours(23) + "' and leirong='" + DropDownList1.SelectedValue + "' and fenlei='" + DropDownList2.SelectedValue + "' and gongchengshi='" + ds2.Tables[0].Rows[yue]["username"].ToString() + "' group by leirong";
