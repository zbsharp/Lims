...
public partial class Report_ReportMonth : System.Web.UI.Page
{
    private int _i = 0;
    ...
    protected DataTable table(string a, string b)
    {
        ...
        for (int yue = 1; yue < 13; yue++)
        {
            ...
            string sql31 = "select count(*) as c1 from BaoGaoChaCuo where month='"+yue+"' and Year(time)='"+TextBox2.Text.Trim()+"'    group by month";
