<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Manage3.aspx.cs" Inherits="ZiYuan_Manage3" %>
                               ...
                               style="font-size: 9pt" onrowcommand="GridView1_RowCommand" OnRowDataBound="GridView1_RowDataBound" >
                                                        ...
                                                        <Columns>
                                                          ...
                                                          <asp:TemplateField HeaderText="序号">
                                                           ...
                                                           <asp:BoundField DataField="testflag" HeaderText="是否需要校准" />
                                                            <asp:BoundField DataField="state1" HeaderText="状态" />
                                                            <asp:BoundField DataField="buydate" DataFormatString="{0:d}" HeaderText="验收日期" />
