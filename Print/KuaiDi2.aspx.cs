...
public partial class Print_KuaiDi2 : System.Web.UI.Page
{
    protected string id = "";
    protected string shoujiandanwei = "";
    protected string shoujianren = "";
    protected string shoujiandizhi = "";
    protected string shoujiandianhua = "";
    protected string jijianren = "";
    protected string jidiandianhua = "";
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        jijianren = ds.Tables[0].Rows[0]["jijianren"].ToString();
        jidiandianhua = ds.Tables[0].Rows[0]["jijiandianhua"].ToString();
        ...
        shoujiandanwei = ds.Tables[0].Rows[0]["shoujiandanwei"].ToString();
        shoujianren = ds.Tables[0].Rows[0]["shoujianren"].ToString();
        shoujiandizhi = ds.Tables[0].Rows[0]["shoujiandizhi"].ToString();
        shoujiandianhua = ds.Tables[0].Rows[0]["shoujiandianhua"].ToString();
