<%@ Page Language="C#" AutoEventWireup="true" CodeFile="KuaiDiPrint.aspx.cs" Inherits="Print_KuaiDiPrint" %>
...
<body style="font:20px; font-family :Times New Roman;">
    <center class="Noprint">
        ...
        <input type="button" value="打印预览" onclick="document.all.WebBrowser.ExecWB(7,1)" />
         <div style ="text-align :center ;">适应顺风快递单打印,纸张大小:21.6*13.9cm,靠右安装,纵向,左3mm上5mm,清空页眉页脚.</div>
