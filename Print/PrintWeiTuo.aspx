<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PrintWeiTuo.aspx.cs" Inherits="Print_PrintWeiTuo" %>
...
<head id="Head1" runat="server">
    ...
    <style type="text/css">
       .tdp 
        ...
        .F_size16 {font-size:21px; position:relative;left:-14%;}
        .F_size17 {font-size:16px;}
