...
public partial class Print_PrintShangBao2 : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        con2.Open();
        string sql = "select * from anjianxinxi2 where taskno='" + tijiaobianhao + "'";
        ...
        string sql10 = "select * from anjianinfo2 where rwbianhao='" + tijiaobianhao + "'";
        ...
        string sql11 = "select * from anjianxinxi2 where taskno='" + tijiaobianhao + "'";
        ...
        string sql12 = "select * from [FuWuFuJian2] where caseid='" + tijiaobianhao + "' order by leibie";
        ...
        {
            con2.Close();
            Response.Redirect("~/Customer/Welcome.aspx?id=rr7");
        }
        ...
        strTable += "<table width=\"97%\" height=30 border=\"0\" align=\"center\"><tr><td align=\"center\" style ='' class=\"F_size16 F_B \">CCC上报文件目录</td></tr></table>";


        strTable += "<table width=\"97%\" align=\"center\" border=\"1\"><tr height=30><td align=\"center\" width=\"15%\"><span style='font-weight :bold ;'>收件人地址：</span></td><td align=\"left\" colspan=\"3\" ><span style='font-weight :bold ;'>(100070)中国北京南四环西路188号9区</span></td></tr>";
        strTable += "<tr height=30><td align=\"center\" width=\"15%\"><span style='font-weight :bold ;'>收件人：</span></td><td align=\"left\" colspan=\"3\" ><span style='font-weight :bold ;'>中国质量认证中心 产品认证一处</span></td></tr>";
        ...
        strTable += "<tr height=30><td align=\"center\" width=\"15%\"><span style='font-weight :bold ;'>申请人：</span></td><td align=\"left\" width=\"35%\"><span style='font-weight :bold ;'>" + dt10.Rows[0]["weituodanwei"].ToString() + "</span></td><td align=\"center\"><span style='font-weight :bold ;'>申请编号：</span></td><td align=\"left\" width=\"35%\"><span style='font-weight :bold ;'>" + dt10.Rows[0]["shenqingbianhao"].ToString() + "</span></td></tr>";
        ...
        strTable += "<table width=\"97%\" height=35 border=\"1\" align=\"center\"><tr><td align=\"center\" style ='' class=\"F_size16 F_B \">详细目录清单</td></tr></table>";
        ...
        strTable += "<td align=\"center\" width=\"6%\"><span style='font-weight :bold ;'>序号</span></td>";
        strTable += "<td align=\"center\" width=\"20%\"><span style='font-weight :bold ;'>文档类别</span></td>";
        strTable += "<td align=\"center\" width=\"60%\"><span style='font-weight :bold ;'>文档名称</span></td>";       
        strTable += "<td align=\"center\" width=\"14%\"><span style='font-weight :bold ;'>备注</span></td>";
        strTable += "</tr>";
        ...
        for (int z = 0; z < ds12.Tables[0].Rows.Count; z++)
        {
            ...
            strTable += "<td align=\"center\" width=\"6%\"><span style='font-weight :bold ;'>" + m + "</span></td>";
            strTable += "<td align=\"center\" width=\"20%\"><span style='font-weight :bold ;'>" + dt12.Rows[z]["leibie"].ToString() + "</span></td>";

            strTable += "<td align=\"center\" width=\"60%\"><span style='font-weight :bold ;'>" + dt12.Rows[z]["baojiaid"].ToString() + "</span></td>";

            strTable += "<td align=\"center\" width=\"14%\"><span style='font-weight :bold ;'>" + dt12.Rows[z]["pub_field3"].ToString() + "</span></td>";
