<%@ Page Language="C#" AutoEventWireup="true" CodeFile="XiaoShouYeJi.aspx.cs" Inherits="TongJi_XiaoShouYeJi" %>
       ...
       结算日期： <input id="txFDate" runat="server" class="TxCss" name="txFDate" onclick="new Calendar().show(this.form.txFDate);"
        ...
        <asp:GridView ID="GridView1" runat="server" Width="100%" AutoGenerateColumns="False"
            ...
            <Columns>
                  ...
                  <asp:BoundField DataField="baojiabumen" HeaderText="报价部门" />

                 <asp:BoundField DataField="yewuyuan" HeaderText="报价人" />
                              
                  <asp:BoundField DataField="taskid" HeaderText="任务编号" />
                    <asp:BoundField DataField="kehuming" HeaderText="客户" />
                       <asp:BoundField DataField="name" HeaderText="产品" />
                       <asp:BoundField DataField="zonghesuan" HeaderText="总金额" />
                        <asp:BoundField DataField="" HeaderText="结算（非代付）" />
