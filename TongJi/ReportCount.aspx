<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ReportCount.aspx.cs" Inherits="TongJi_ReportCount" %>
...
<body>
    ...
    <div class="Body_Title">
        统计管理 》》完成检测报告</div>
         ...
         批准日期： <input id="txFDate" runat="server" class="TxCss" name="txFDate" onclick="new Calendar().show(this.form.txFDate);"
