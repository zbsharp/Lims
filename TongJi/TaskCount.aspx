<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TaskCount.aspx.cs" Inherits="TongJi_TaskCount" %>
...
<body>
    ...
    <div class="Body_Title">
        ...
        <asp:Button ID="Button2"  CssClass ="BnCss"  runat="server" 
            ...
            onclick="Button1_Click" Text="导出excel" /><a href="#"  onclick ="javascript:window.open('TaskCount1.aspx')">分部门明细</a>
                            ...
                            <table width="100%" class="Admin_Table" 
                               ...
                               <tr><td align ="left" >
                               该页面统计的数量是在以下达日期为准一段时间内所有的任务数量。"工程统计"页面只统计已经分派了工程师的任务数量。
