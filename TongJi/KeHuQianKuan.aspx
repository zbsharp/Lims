<%@ Page Language="C#" AutoEventWireup="true" CodeFile="KeHuQianKuan.aspx.cs" Inherits="TongJi_KeHuQianKuan" %>
...
<body>
    ...
    <div>
        <div class="Body_Title">
            统计管理 》》客户应收款</div>
       请款开出日期： <input id="txFDate" runat="server" class="TxCss" name="txFDate" onclick="new Calendar().show(this.form.txFDate);"
        ...
        <asp:GridView ID="GridView1" runat="server" Width="99%" ShowFooter ="true"  AutoGenerateColumns="False"
            ...
            <Columns>
                    ...
                    <asp:BoundField DataField="kehuname" HeaderText="客户" />
                       ...
                       <asp:BoundField DataField="yins" HeaderText="应收款" />
                   <asp:BoundField DataField="yis" HeaderText="已收款" />
