<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Settle.aspx.cs" Inherits="TongJi_Settle" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div>
            结案日期：<input id="txFDate" runat="server" class="TxCss" name="txFDate" onclick="new Calendar().show(this.form.txFDate);"
                ...
                <ContentTemplate>
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="kehuleixing" HeaderText="客户类型" />
