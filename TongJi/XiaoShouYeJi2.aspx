<%@ Page Language="C#" AutoEventWireup="true" CodeFile="XiaoShouYeJi2.aspx.cs" Inherits="TongJi_XiaoShouYeJi2" %>
       ...
       结算日期： <input id="txFDate" runat="server" class="TxCss" name="txFDate" onclick="new Calendar().show(this.form.txFDate);"
        ...
        <asp:GridView ID="GridView1" runat="server" Width="100%" AutoGenerateColumns="False"
            ...
            <Columns>
                  ...
                  <asp:BoundField DataField="" HeaderText="所在部门" />

                 <asp:BoundField DataField="" HeaderText="报价人" />
                              
                  <asp:BoundField DataField="taskid" HeaderText="任务编号" />
                    <asp:BoundField DataField="" HeaderText="客户" />
                       <asp:BoundField DataField="" HeaderText="产品" />
                       <asp:BoundField DataField="" HeaderText="检测类别" />
                        <asp:BoundField DataField="" HeaderText="结算金额" />
                         <asp:BoundField DataField="" DataFormatString ="{0:d}" HeaderText="结算日期" />
                      ...
                      <asp:BoundField DataField="" HeaderText="代付" />
                      <asp:BoundField DataField="" HeaderText="委托方" />
