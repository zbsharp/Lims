<%@ Page Language="C#" AutoEventWireup="true" CodeFile="JieSuanCount.aspx.cs" Inherits="TongJi_JieSuanCount" %>
    ...
    <div>
       ...
       结算日期： <input id="txFDate" runat="server" class="TxCss" name="txFDate" onclick="new Calendar().show(this.form.txFDate);"
        ...
        <asp:GridView ID="GridView1" runat="server" Width="100%" AutoGenerateColumns="False"
             CssClass="Admin_Table"  ShowFooter ="true" OnRowDataBound="GridView1_RowDataBound"
            >
            <Columns>
          
                  
                       <asp:BoundField DataField="shiyanleibie" HeaderText="检测类别" />
                        <asp:BoundField DataField="feiyong" HeaderText="结算金额" />
                     ...
                     <asp:BoundField DataField="" HeaderText="佛山" />
                          <asp:BoundField DataField="" HeaderText="代付" />

                           
                           <asp:BoundField DataField=""   HeaderText="合计(结算金额-代付)" />
