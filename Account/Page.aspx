<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Page.aspx.cs" Inherits="Account_Page" %>
        ...
        <legend style="color: Red">应收款项目</legend>
                    ...
                    <ItemTemplate>
                        <asp:LinkButton ID="LinkButton5" runat="server" Text="核算" CommandArgument='<%# Eval("rwbianhao") %>'
                            CommandName="xiada"></asp:LinkButton>|| <asp:LinkButton ID="LinkButton1" runat="server" Text="关闭" CommandArgument='<%# Eval("rwbianhao") %>'
                            CommandName="xiada1"></asp:LinkButton>|| <asp:LinkButton ID="LinkButton2" runat="server" Text="中止" CommandArgument='<%# Eval("rwbianhao") %>'
                            CommandName="xiada2"></asp:LinkButton>|| <asp:LinkButton ID="LinkButton3" runat="server" Text="完成" CommandArgument='<%# Eval("rwbianhao") %>'
                            CommandName="xiada3"></asp:LinkButton>|| <asp:LinkButton ID="LinkButton4" runat="server" Text="正常" CommandArgument='<%# Eval("rwbianhao") %>'
                            CommandName="xiada4"></asp:LinkButton>|| <span style="cursor: hand;
                                                    color: Blue;" onclick="window.open('../Case/Tasksee.aspx?tijiaobianhao=<%#Eval("bianhao") %>&&chakan=0')">
