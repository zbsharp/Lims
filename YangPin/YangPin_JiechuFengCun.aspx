<%@ Page Language="C#" AutoEventWireup="true" CodeFile="YangPin_JiechuFengCun.aspx.cs" Inherits="YangPin_YangPin_JiechuFengCun" %>
...
<asp:ScriptManager ID="ScriptManager1" runat="server" EnableScriptGlobalization="false" EnableScriptLocalization="false">
    ...
    <table align="center" border="0" cellpadding="3" cellspacing="1" style="background-color: #b9d8f3"
                        ...
                        <tr bgcolor="#f4faff">
                            ...
                            <td style="text-align: left">
                                ...
                                <asp:Button ID="Button2" runat="server" Text="确认" onclick="Button2_Click" 
                                    Height="22px" Width="79px" />(扫描条码前请确认光标在左侧文本框且输入法处于英文状态)</td>
                        ...
                        <tr bgcolor="#f4faff">
                            ...
                            OnRowUpdating="GridView2_RowUpdating">
                                 ...
                                 <asp:BoundField DataField="anjianid" HeaderText="任务号" />
                                  <asp:BoundField DataField="ztt" HeaderText="任务状态" />
                        ...
                        <tr bgcolor="#f4faff">
                            <td colspan="4" style="text-align: center">
                                <asp:Button ID="Button1" runat="server" CausesValidation="False" CssClass="BnCss"
                                    Text="确认销毁" OnClick="Button1_Click" />
        ...
        <tr bgcolor="#f4faff">
            <td colspan="4" style="text-align: left">最近销毁列表
                                        ...
                                        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CssClass="Admin_Table"  OnRowDataBound="GridView1_RowDataBound"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="name" HeaderText="销毁处理人"  />
                                                <asp:BoundField DataField="filltime"  HeaderText="销毁时间" />
                                    ...
                                    <ItemTemplate>
                                       ...
                                       <HeaderStyle CssClass="Admin_Table_Title " />
                                         ...
                                         <asp:TextBox ID="TextBox5" runat="server" Width="27%" Visible="False"></asp:TextBox>
