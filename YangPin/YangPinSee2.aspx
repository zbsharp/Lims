<%@ Page Language="C#" AutoEventWireup="true" CodeFile="YangPinSee2.aspx.cs" Inherits="YangPin_YangPinSee2" %>
        ...
        <div>
            ...
            <table align="center" border="0" cellpadding="3" cellspacing="1" style="background-color: #b9d8f3"
                ...
                <tr bgcolor="#f4faff" style="display: none;">
                    <td style="text-align: left; width: 90px;">厂商名称：</td>
                    <td colspan="3" style="text-align: left">
                        <asp:TextBox ID="TextBox1" runat="server" Width="90%"></asp:TextBox></td>
                </tr>
                <tr bgcolor="#f4faff">
                    <td style="text-align: left; width: 90px;">案件编号：</td>
                    <td style="text-align: left">
                        <asp:TextBox ID="TextBox2" runat="server"></asp:TextBox></td>
                    <td style="text-align: left; width: 110px;">服务编号：</td>
                    <td style="text-align: left">
                        <asp:TextBox ID="TextBox3" runat="server"></asp:TextBox></td>
                </tr>
                <tr bgcolor="#f4faff">
                    <td style="text-align: left; width: 90px;">样品编号：</td>
                    <td style="text-align: left">
                ...
                <tr bgcolor="#f4faff">
                    <td style="text-align: left; width: 90px;">型号：</td>
                    <td style="text-align: left">
                        <asp:TextBox ID="TextBox5" runat="server"></asp:TextBox></td>
                    <td style="text-align: left; width: 110px;">测试项目报告种类：</td>
                    <td style="text-align: left">
                ...
                <tr bgcolor="#f4faff">
                    ...
                    <td style="text-align: left; width: 110px;">单位：</td>
                    <td style="text-align: left">
                        <asp:TextBox ID="TextBox8" runat="server"></asp:TextBox></td>
                </tr>
                <tr bgcolor="#f4faff">
                    <td style="width: 90px; text-align: left">制造厂商：</td>
                    <td style="text-align: left">
                        <asp:TextBox ID="TextBox9" runat="server"></asp:TextBox></td>
                    <td style="width: 110px; text-align: left">收到日期：</td>
                    <td style="text-align: left">
                        <asp:TextBox ID="TextBox11" runat="server" onclick="popUpCalendar(this,document.forms[0].TextBox11,'yyyy-mm-dd')"></asp:TextBox></td>
                </tr>
                <tr bgcolor="#f4faff">
                    <%--<td style="width: 110px; text-align: left">保管要求：</td>
                    <td style="text-align: left">
                ...
                <tr bgcolor="#f4faff">
                    <td style="text-align: left; width: 90px;">备注：</td>
                    <td colspan="3" style="text-align: left">
                        <asp:TextBox ID="TextBox10" runat="server" Width="90%"></asp:TextBox></td>
                </tr>
                <tr bgcolor="#f4faff">
                    <td style="text-align: left; width: 90px;">价值类别：</td>
                    <td colspan="3" style="text-align: left">
                        ...
                        </asp:DropDownList>保存区：<asp:DropDownList ID="DropDownList2" runat="server">
                    ...
                    <td style="text-align: left">
                        ...
                        <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" CssClass="Admin_Table" DataKeyNames="id"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="remark" HeaderText="备注" />
                                <asp:BoundField DataField="state" HeaderText="类别" />
