<%@ Page Language="C#" AutoEventWireup="true" EnableViewState ="true" CodeFile="YangPinSee.aspx.cs" Inherits="YangPinSee" %>
         ...
         <tr bgcolor="#f4faff">
           <%-- <td style="width: 110px; text-align: left">
            ...
            <td style="text-align: left" >
             ...
             <td>
                 <asp:TextBox ID="txtbiaoqianremork" runat="server"></asp:TextBox></td>
        </tr>
                        <tr bgcolor="#f4faff">
                            <td style="text-align: left; width: 90px;">
                                备注：</td>
                    ...
                    <asp:ListItem>B2</asp:ListItem>
                            ...
                            &nbsp; 保存区：<asp:DropDownList ID="DropDownList2" runat="server">
...
">C3-3</asp:ListItem>
                        ...
                        <tr bgcolor="#f4faff">
                            <td colspan="4" style="text-align: center">
                                ...
                                <asp:Button ID="Button2" runat="server" Text="打印标签" onclick="Button2_Click" Visible="False" />
                                <asp:Button ID="Button3" runat="server" Text="生成新样品" onclick="Button3_Click" Visible="False" />
