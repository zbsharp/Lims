<%@ Page Language="C#" AutoEventWireup="true" CodeFile="YangPinManage6.aspx.cs" Inherits="YangPin_YangPinManage6" %>
            ...
            <tr>
                <td align="left" style="height: 25px">
                    ...
                    <input id="txTDate" visible="false" runat="server" class="TxCss" name="txTDate" onclick="new Calendar().show(this.form.txTDate);"
                        style="width: 90px" type="text" />借出人：
                ...
                <asp:DropDownList ID="DropDownList1" runat="server">
                    ...
                    <asp:ListItem Value="7">样品型号</asp:ListItem>
                    ...
                    <asp:GridView ID="GridView1" runat="server" Width="100%" AutoGenerateColumns="false"
                        ...
                        <Columns>
                            <asp:TemplateField HeaderText="序号">
                                <ItemTemplate>
                                    <asp:Label ID="Label3" runat="server" Text='<%# (Container.DisplayIndex+1).ToString("000") %>'
                                        ForeColor="Green"></asp:Label>
                                </ItemTemplate>
                                <ItemStyle ForeColor="Green" />
                            </asp:TemplateField>

                            <asp:HyperLinkField HeaderText="样品编号" DataTextField="sampleid" Target="_blank" DataNavigateUrlFormatString="~/YangPin/YangPinSee2.aspx?yangpinid={0}"
                                DataNavigateUrlFields="id" />


                            <asp:HyperLinkField HeaderText="任务编号" DataTextField="anjianid" Target="_blank" DataNavigateUrlFormatString="~/Case/Tasksee.aspx?tijiaobianhao={0}&&chakan=0"
                                DataNavigateUrlFields="bianhao" />

                            <asp:BoundField DataField="anjianid" HeaderText="任务号" Visible="false" />
                            ...
                            <asp:BoundField DataField="zt" HeaderText="任务状态" />
                            <asp:BoundField DataField="pub_field2" HeaderText="类别" />
                            <asp:BoundField DataField="beizhu2" HeaderText="借出人" />
                            ...
                            <asp:TemplateField HeaderText="操作" Visible="false">
                                <ItemTemplate>
                                    <span style="cursor: hand; color: Blue;" onclick="window.open('YangPin_Jiechu.aspx?sampleid=<%#Eval("sampleid") %>')">
                                        <asp:Label ID="seeLB" runat="server" Text="借出"></asp:Label></span> || <span style="cursor: hand; color: Blue;"
                                            onclick="window.open('YangPin_FanHuan.aspx?sampleid=<%#Eval("sampleid") %>')">
                            ...
                            <%--     <asp:HyperLinkField HeaderText="催还" Text="催还" Target="_blank" DataNavigateUrlFormatString="~/Print/YangPinCuiHuan.aspx?sampleid={0}&&caozuo=2"
                            DataNavigateUrlFields="sampleid" />--%>



                            <asp:BoundField DataField="beizhu1" HeaderText="未还备注" />

                            <asp:BoundField DataField="fuwuid" HeaderText="任务完成日期" />
                            <asp:BoundField DataField="" HeaderText="已用天数" Visible="false" />
