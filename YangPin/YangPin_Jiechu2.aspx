<%@ Page Language="C#" AutoEventWireup="true" CodeFile="YangPin_Jiechu2.aspx.cs" Inherits="YangPin_YangPin_Jiechu2" %>
    ...
    <form name="form1" runat="server" id="form1">
        ...
        <div>
            ...
            <table align="center" border="0" cellpadding="3" cellspacing="1" style="background-color: #b9d8f3"
                width="100%">
                <tr bgcolor="#f4faff">
                    <td style="text-align: left;" class="style1">请扫描或者输入完整样品编号：</td>
                    <td style="text-align: left" colspan="3">
                        <asp:TextBox ID="TextBox1" runat="server"></asp:TextBox>
                        <asp:Button ID="Button2" runat="server" Text="确认" OnClick="Button2_Click" />(扫描条码前请确认光标在左侧文本框且输入法处于英文状态)
                    </td>
                                ...
                                <asp:TemplateField HeaderText="查看">
                                    <ItemTemplate>
                                        <span style="cursor: hand; color: Blue;"
                                            onclick="window.open('YangPinSee1.aspx?yangpinid=<%#Eval("sid") %>')">
                ...
                <tr bgcolor="#f4faff">
                    <td colspan="4" style="text-align: center">
                        ...
                        给领用人：<asp:DropDownList ID="DropDownList2" runat="server"
                ...
                <tr bgcolor="#f4faff">
                    <td colspan="4" style="text-align: left">最近借出列表
                                        ...
                                        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CssClass="Admin_Table"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="查看">
                                                    <ItemTemplate>
                                                        <span style="cursor: hand; color: Blue;"
                                                            onclick="window.open('YangPinSee1.aspx?yangpinid=<%#Eval("sampleid") %>')">
