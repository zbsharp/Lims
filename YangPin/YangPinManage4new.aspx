<%@ Page Language="C#" AutoEventWireup="true" CodeFile="YangPinManage4new.aspx.cs" Inherits="YangPin_YangPinManage4new" %>
        ...
        <input id="txTDate" runat="server" class="TxCss" name="txTDate" onclick="new Calendar().show(this.form.txTDate);"
            style="width: 90px" type="text" visible="true" />
                ...
                <asp:Button ID="Button1" runat="server" CssClass="BnCss" OnClick="Button1_Click"
                    Text="导出excel" />
                <asp:Button ID="Button3" runat="server" Text="样品登记" OnClick="Button3_Click" />
                <asp:Button ID="Button4" runat="server" Text="批量处理" OnClick="Button4_Click" />
                                    ...
                                    <ItemTemplate>
                                        <span style="cursor: hand; color: Blue;" onclick="window.open('YangPinFenCun.aspx?sampleid=<%#Eval("sampleid") %>')">
                                            <asp:Label ID="seeLB" runat="server" Text="封存"></asp:Label></span>|| <span style="cursor: hand;
                                                color: Blue;" onclick="window.open('YangPinPiLiang.aspx?sampleid=<%#Eval("sampleid") %>&&caozuo=1')">
                                                <asp:Label ID="Label4" runat="server" Text="清退"></asp:Label></span>|| <span style="cursor: hand;
                                                    color: Blue;" onclick="window.open('YangPinPiLiang.aspx?sampleid=<%#Eval("sampleid") %>&&caozuo=3')">
                                                    <asp:Label ID="Label5" runat="server" Text="销毁"></asp:Label></span>||<span style="cursor: hand;
