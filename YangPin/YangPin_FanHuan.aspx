<%@ Page Language="C#" AutoEventWireup="true" EnableViewState ="true" CodeFile="YangPin_FanHuan.aspx.cs" Inherits="YangPin_FanHuan" %>
                                ...
                                <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
                                    ...
                                    <ContentTemplate>
                                        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False"  OnRowDataBound="GridView1_RowDataBound"
                                           CssClass="Admin_Table"  Width="100%">
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="time" DataFormatString="{0:d}" HeaderText="返还时间" />
