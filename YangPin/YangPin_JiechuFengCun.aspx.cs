...
public partial class YangPin_YangPin_JiechuFengCun : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        {
              string sqlc = "select * from YangPin2Detail where sampleid='" + ds10.Tables[0].Rows[i]["sid"].ToString() + "' and state='销毁'";
