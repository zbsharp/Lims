<%@ Page Language="C#" AutoEventWireup="true" EnableViewState="true" CodeFile="YangPinManage1.aspx.cs"
    Inherits="YangPinManage1"   EnableEventValidation="false" 
%>
        ...
        <tr>
            <td align="left" style="height: 25px">
                <asp:DropDownList ID="DropDownList4" runat="server">
                    <asp:ListItem Value="receivetime">接收日期</asp:ListItem>
                    <asp:ListItem Value="beizhu3">返还日期</asp:ListItem>
                </asp:DropDownList>
                ...
                <asp:DropDownList ID="DropDownList1" runat="server">
                    ...
                    <asp:ListItem Value="7">封存编号</asp:ListItem>
                     <asp:ListItem Value="8">保存位置</asp:ListItem>
                </asp:DropDownList>
                ...
                <asp:Button ID="Button1" runat="server" CssClass="BnCss" OnClick="Button1_Click"
                    Text="导出excel" />
                <asp:Button ID="Button3" runat="server" Text="样品登记" Visible ="false"  OnClick="Button3_Click" />
        ...
        <tr>
            <td align="left">
                <asp:GridView ID="GridView1" runat="server" Width="100%" AutoGenerateColumns="False"
                    CssClass="Admin_Table" OnRowDataBound="GridView1_RowDataBound" OnRowCommand="GridView1_RowCommand" OnRowDeleting="GridView1_RowDeleting">
                    <Columns>
                        ...
                        <asp:BoundField DataField="kf" HeaderText="业务员" />
                                ...
                                <span style="cursor: hand; color: Blue;" onclick="window.open('YangPinSee.aspx?yangpinid=<%#Eval("id") %>')">
                                    <asp:Label ID="seeLB" runat="server" Text="编辑"></asp:Label></span>|| <span style="cursor: hand;
                                        ...
                                        <asp:Label ID="Label3" runat="server" Text="标签"></asp:Label></span>|| <span style="cursor: hand;
                                            ...
                                            <asp:Label ID="Label7" runat="server" Text="样品"></asp:Label></span>
                                || <span style="cursor: hand; color: Blue;" onclick="window.open('../Case/Tasksee.aspx?tijiaobianhao=<%#Eval("bianhao") %>&&chakan=0')">
                                    <asp:Label ID="Label4" runat="server" Text="任务"></asp:Label></span>

                               <%-- <span style="cursor: hand;color: Blue;" onclick="window.open('../Print/YangPinCuiHuan.aspx?sampleid=<%#Eval("sampleid") %>&&caozuo=2')">
                        ...
                        <asp:BoundField DataField="dajine" HeaderText="到账" Visible="False" />
                         <asp:BoundField DataField="rr" HeaderText="处置" />
