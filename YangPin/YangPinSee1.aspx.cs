...
public partial class YangPin_YangPinSee1 : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        con.Open();
        string sql = "select * from YangPin2 where sampleid='" + yangpinid + "'";
        ...
        if (dr.Read())
        {
            ...
            //DropDownList2.SelectedValue = dr["pub_field4"].ToString();
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            string sql = "update YangPin2 set pub_field4='" + bumen2 + "',pub_field3='" + bumen1 + "', kehuname='" + TextBox1.Text + "',anjianid='" + TextBox2.Text + "',fuwuid='" + TextBox3.Text + "',name='" + TextBox4.Text + "',model='" + TextBox5.Text + "',type='" + TextBox6.Text + "',count='" + Convert.ToInt32(TextBox7.Text) + "',danwei='" + TextBox8.Text + "',position='" + TextBox9.Text + "',remark='" + TextBox10.Text + "',receivetime='" + TextBox11.Text + "',sampleid='" + TextBox12.Text + "' where (id='" + yangpinid + "')";
    ...
    protected void GridView2_RowUpdating(object sender, GridViewUpdateEventArgs e)
    {
        ...
        string uuname4 = Server.HtmlEncode(((TextBox)this.GridView2.Rows[e.RowIndex].Cells[5].Controls[0]).Text.ToString());


        string sql = "update YangPin2Detail set remark='" + uuname4 + "' where id='" + KeyId + "'";
