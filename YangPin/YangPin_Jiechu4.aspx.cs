...
public partial class YangPin_YangPin_Jiechu4 : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        {
              //string sqlc = "select * from YangPin2Detail where sampleid='" + ds10.Tables[0].Rows[i]["sid"].ToString() + "' and state='清退'";
              ...
              //  else
                {
                    ...
                    string sql = "insert into YangPin2Detail values('" + ds10.Tables[0].Rows[i]["sid"].ToString() + "','" + ds10.Tables[0].Rows[i]["spname"].ToString() + "','" + TextBox3.Text.Trim() + "','" + ds10.Tables[0].Rows[i]["beizhu"].ToString() + "','" + DropDownList1.SelectedValue + "','" + TextBox7.Text + "','" + Session["username"].ToString() + "','" + DateTime.Now + "','','','','','')";
    ...
    protected void Bind1()
    {
        ...
        string sql = "select top 10 *,(select top 1 anjianid from yangpin2 where sampleid=YangPin2Detail.sampleid) as anjianid from YangPin2Detail where state='" + DropDownList1.SelectedValue + "' order by id desc";
