<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ChuCuoLeiBieM4.aspx.cs" Inherits="SysManage_ChuCuoLeiBieM4" %>
...
<asp:ScriptManager ID="ScriptManager1" runat="server" EnableScriptGlobalization="false" EnableScriptLocalization="false">
  ...
  <asp:HyperLinkField DataNavigateUrlFields="departmentid" DataNavigateUrlFormatString="~/SysManage/ChuCuoLeiBie1aspx2.aspx?id={0}"
