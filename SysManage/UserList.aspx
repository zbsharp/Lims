<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UserList.aspx.cs" Inherits="SysManage_UserList" %>
...
<body>
    ...
    <asp:Button ID="Button1" class="BnCss" runat="server" Text="查 询" OnClick="Button1_Click1"
        Width="60px" />
    <asp:Button ID="Button2" class="BnCss" runat="server" Text="增加用户" OnClick="Button2_Click" />
      <asp:Button
        ID="Button3" runat="server" Text="全部" onclick="Button3_Click" />
