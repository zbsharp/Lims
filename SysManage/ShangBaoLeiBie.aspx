<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ShangBaoLeiBie.aspx.cs" Inherits="SysManage_ShangBaoLeiBie" %>
                    ...
                    <ContentTemplate>
                        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CssClass="Admin_Table"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="name" HeaderText="检测标准" />
                                <asp:BoundField DataField="wenyuan" HeaderText="检测项目"  />
