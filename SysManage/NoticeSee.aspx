<%@ Page Language="C#" AutoEventWireup="true" CodeFile="NoticeSee.aspx.cs" Inherits="SysManage_NoticeSee" %>
      ...
      <tr bgcolor="#f4faff" style ="display :none;">
        ...
        <tr bgcolor="#f4faff">
            <td align="left" style="width: 90px">
                通知内容：</td>
            <td align="left" colspan="3">
                <asp:TextBox ID="TextBox3" runat="server" Width="90%" TextMode ="MultiLine" ></asp:TextBox></td>
        </tr>
        <tr bgcolor="#f4faff">
            <td align="left" style="width: 90px">
                发布日期：</td>
