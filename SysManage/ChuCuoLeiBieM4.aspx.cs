...
public partial class SysManage_ChuCuoLeiBieM4 : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        string sql = "select * from  UserChuCuoWenJian where (name like '%" + TextBox6.Text.Trim() + "%' or wenyuan like '%" + TextBox6.Text.Trim() + "%') and fillname='刘腾良'";
    ...
    protected void Bind()
    {
        ...
        string sql = "select * from UserChuCuoWenJian where fillname='刘腾良' order by departmentid desc";
        SqlDataAdapter ad = new SqlDataAdapter(sql, con);
        DataSet ds = new DataSet();
        ad.Fill(ds);
