<%@ Page Language="C#" AutoEventWireup="true" EnableViewState ="true" CodeFile="DataBase_department.aspx.cs" Inherits="CCSZJiaoZhun_htw_DataBase_department" %>
                    ...
                    <ContentTemplate>
                        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CssClass="Admin_Table"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="name" HeaderText="部门" ReadOnly="True" />
                                <asp:BoundField DataField="wenyuan" HeaderText="文员" />
