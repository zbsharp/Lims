...
public partial class SysManage_ChuCuoLeiBieM2 : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        string sql = "select * from  UserChuCuoWenJian where name like '%" + TextBox6.Text.Trim() + "%' or wenyuan like '%" + TextBox6.Text.Trim() + "%'";
