<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ProductPriceDetail.aspx.cs" Inherits="SysManage_ProductPriceDetail" %>
...
<asp:ScriptManager ID="ScriptManager1" runat="server" EnableScriptGlobalization="false" EnableScriptLocalization="false">
      ...
      <div class="Body_Title">系统管理 》》价格明细</div>
                    ...
                    <table class="Admin_Table">
                        ...
                        <tr bgcolor="#f4faff">
                            ...
                            <td colspan="3" style="text-align: left">
                                <asp:TextBox ID="TextBox11" runat="server" Width="90%"></asp:TextBox></td>
                        </tr>
                        <tr bgcolor="#f4faff">
