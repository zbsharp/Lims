...
public partial class SysManage_ModuleSearch : System.Web.UI.Page
{
    ...
    protected void Button2_Click(object sender, EventArgs e)
    {
        ...
        if (TextBox1.Text.Trim() == "") 
        {
            ...
            sqlstr = "select * from ModuleDuty where  modulename like '%" + DropDownList2.SelectedItem.Text + "%' and dutyname !='' order by name asc ";
