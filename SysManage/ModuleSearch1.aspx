<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ModuleSearch1.aspx.cs" Inherits="SysManage_ModuleSearch1" %>
...
<body>
    ...
    <asp:Button ID="Button1" CssClass="BnCss" runat="server" Visible ="false"  OnClick="Button1_Click"
        Text="取消权限" />
