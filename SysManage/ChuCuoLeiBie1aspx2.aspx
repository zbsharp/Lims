<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ChuCuoLeiBie1aspx2.aspx.cs" Inherits="SysManage_ChuCuoLeiBie1aspx2" %>
     ...
     <table align="center" border="0" cellpadding="3" cellspacing="1" style="background-color: #b9d8f3"
        ...
        <tr bgcolor="#f4faff">
            <td colspan="6" style="text-align: center">
                                ...
                                <asp:Button ID="Button2" runat="server" Text="修改文件类别" Visible ="false"  onclick="Button2_Click" />
                                <asp:Button ID="Button3" runat="server" Text="删除该文件" Visible ="false"  onclick="Button3_Click" />
      ...
      <tr bgcolor="#f4faff">
        ...
        <tr bgcolor="#f4faff">
            <td>
                <asp:FileUpload ID="FileUpload1" runat="server" Width="40%" Visible ="false" />
                <asp:Button ID="Button4" runat="server" CausesValidation="false" Visible ="false"  CssClass="BnCss"
