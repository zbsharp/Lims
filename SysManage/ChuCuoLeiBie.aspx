<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ChuCuoLeiBie.aspx.cs" Inherits="SysManage_ChuCuoLeiBie" %>
                    ...
                    <ContentTemplate>
                        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CssClass="Admin_Table"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="name" HeaderText="错误类别" />
                                <asp:BoundField DataField="wenyuan" HeaderText="错误内容"  />
