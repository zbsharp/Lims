<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ZanTingLeiBie.aspx.cs" Inherits="SysManage_ZanTingLeiBie" %>
                    ...
                    <ContentTemplate>
                        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CssClass="Admin_Table"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="name" HeaderText="暂停类别" />
                                <asp:BoundField DataField="wenyuan" HeaderText="暂停原因"  />
