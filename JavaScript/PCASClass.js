...
{
    selProvince.options[0]=new Option("全国","000000");
    for(i=0;i<Provinces.length;i++)
    {
        selProvince.options[i+1]=new Option(Provinces[i][1],Provinces[i][0]);
        if(selProvince.options[i+1].text==document.getElementById("Province").value)
...
function FillCitys(selCity,ProvinceCode)
{
        if(ProvinceCode=="110000"||ProvinceCode=="120000"||ProvinceCode=="310000"
             ...
             count=0;
                ...
                {selCity.options[0]=new Option("所有地区",ProvinceCode);
                count=1;}
    for(i=0;i<Citys.length;i++)
    {
        if(Citys[i][0].toString().substring(0,2)==ProvinceCode.substring(0,2))
        {
            ...
            if (selCity.options[count].text == document.getElementById("City").value)
...
function InitCitySelect() {
    var selProvince=document.getElementById("DDLProvince");
    var selCity = document.getElementById("DDLCity");
