<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ZiLiaoAddM.aspx.cs" Inherits="Case_ZiLiaoAddM" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="cc1" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>资料清单(客服人员)</title>
...
<body>
    ...
    <asp:ScriptManager ID="ScriptManager1" runat="server" EnableScriptGlobalization="false"
        EnableScriptLocalization="false">
                  ...
                  <div style ="text-align :center ;">    资料清单(客服人员)<asp:Label ID="Label2" runat="server" Text=""  ForeColor ="Red" ></asp:Label></div>  
                    ...
                    <asp:UpdatePanel ID="UpdatePanel2" runat="server" UpdateMode="Conditional">
                        <ContentTemplate>
                            <asp:GridView ID="GridView1" runat="server" DataSourceID="SqlDataSource1" AutoGenerateColumns="False"
                                ...
                                <asp:BoundField DataField="bz" HeaderText="顺序"   />
                                        ...
                                        <ItemTemplate>
                                            <asp:Label ID="timeLabel" runat="server" Text='<%# Eval("renwuname") %>'></asp:Label>
                                             <asp:TextBox ID="timeLabel3" runat="server" Text='<%# Eval("renwuname") %>' Visible="false"
                                                Width="100px" Wrap="true" TextMode="MultiLine"></asp:TextBox>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                 ...
                                 <%--   <asp:TemplateField HeaderText="首次提供">
                                    ...
                                    <asp:TemplateField HeaderText="首次提供" ItemStyle-BackColor ="#FFFFCC" Visible="False" >
                                                    <ItemTemplate>
                                                        <asp:Label ID="shebei1Label" runat="server" Text='<%# Eval("gongchengshi") %>'></asp:Label>
                                   ...
                                   <%-- <asp:TemplateField HeaderText="需要修正">
                                     ...
                                     <asp:TemplateField HeaderText="需要补正"  ItemStyle-BackColor ="AliceBlue" Visible="False" >
                                                    <ItemTemplate>
                                                        <asp:Label ID="shebei2Label" runat="server" Text='<%# Eval("kaishiriqi") %>'></asp:Label>
                                    ...
                                    <asp:TemplateField HeaderText="补正原因"  ItemStyle-BackColor ="AliceBlue" Visible="False" >
                                        <ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="首提日期"  ItemStyle-BackColor ="AliceBlue" Visible="False" >
                                        <ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="修正情况" ItemStyle-BackColor ="AntiqueWhite" Visible="False"  >
                                        <ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="修正日期" ItemStyle-BackColor ="AntiqueWhite" Visible="False" >
                                        <ItemTemplate>
                                   ...
                                   <%-- <asp:TemplateField HeaderText="工程确认">
                                      ...
                                      <asp:TemplateField HeaderText="工程确认" ItemStyle-BackColor ="#99CCFF" Visible="False"  >  
                                                    <ItemTemplate>
                                                        <asp:Label ID="shebei6Label" runat="server" Enabled ="false"  Text='<%# Eval("beizhu") %>'></asp:Label>
                                                        <asp:DropDownList ID="shebei6" runat="server" Enabled ="false"  Visible="false" AutoPostBack="true">
                                                            <asp:ListItem></asp:ListItem>
                                                   ...
                                                   <asp:TemplateField HeaderText="确认情况" ItemStyle-BackColor ="#99CCFF" Visible="False"  >
                                        <ItemTemplate>
                                            <asp:Label ID="timeLabelbb" Enabled ="false"  runat="server" Text='<%# Eval("beizhu1") %>'></asp:Label>
                                             <asp:TextBox ID="timeLabel3bb" Enabled ="false"  runat="server" Text='<%# Eval("beizhu1") %>' Visible="false"
                                                Width="100px" Wrap="true" TextMode="MultiLine"></asp:TextBox>
                                        </ItemTemplate>
                                                       <ItemStyle BackColor="#99CCFF" />
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="确认日期"  ItemStyle-BackColor ="#99CCFF" Visible="False" >
                                        <ItemTemplate>
                                            <asp:Label ID="paixu1" runat="server" Enabled ="false"  Text='<%# Eval("beizhu3") %>'></asp:Label>
                                           <asp:TextBox ID="paixutext" runat="server" Enabled ="false"  Text='<%# Eval("beizhu3") %>' Visible="false"
                                                Width="100px"></asp:TextBox>
                                        </ItemTemplate>
                                        <ItemStyle BackColor="#99CCFF" />
                                    </asp:TemplateField>
                    ...
                    <asp:Button ID="Button1" runat="server" OnClick="Button1_Click" CssClass="BnCss"
                        Text="增加资料" />
                    <asp:Button ID="Button3" runat="server" onclick="Button3_Click" Text="打印补充资料" Visible="False" />
                    <asp:Button ID="Button2" runat="server" Text="回到顶部" />
