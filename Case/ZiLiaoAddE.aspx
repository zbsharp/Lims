<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ZiLiaoAddE.aspx.cs" Inherits="Case_ZiLiaoAddE" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="cc1" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>资料清单(工程师)</title>
...
<body>
    ...
    <asp:ScriptManager ID="ScriptManager1" runat="server" EnableScriptGlobalization="false"
        EnableScriptLocalization="false">
                  ...
                  <div style ="text-align :center ;">    资料清单(工程师)<asp:Label ID="Label2" runat="server" Text=""  ForeColor ="Red" ></asp:Label></div>  
                                ...
                                <asp:BoundField DataField="bz" HeaderText="顺序"   />
                                    ...
                                    <asp:TemplateField HeaderText="备注" Visible="False" >
                                        <ItemTemplate>
                                            <asp:Label ID="timeLabel" runat="server" Text='<%# Eval("renwuname") %>'></asp:Label>
                                             <asp:TextBox ID="timeLabel3" Enabled ="false" runat="server" Text='<%# Eval("renwuname") %>' Visible="false"
                                 ...
                                 <%--   <asp:TemplateField HeaderText="首次提供">
                                    ...
                                    <asp:TemplateField HeaderText="首次提供" ItemStyle-BackColor ="#FFFFCC" Visible="False" >
                                                    <ItemTemplate>
                                                        <asp:Label ID="shebei1Label" runat="server" Text='<%# Eval("gongchengshi") %>'></asp:Label>
                                                        <asp:DropDownList ID="shebei1Label3" Enabled ="false"  runat="server" Visible="false" AutoPostBack="true">
                                   ...
                                   <%-- <asp:TemplateField HeaderText="需要修正">
                                    ...
                                    <asp:TemplateField HeaderText="修正情况" ItemStyle-BackColor ="AntiqueWhite" Visible="False"  >
                                        <ItemTemplate>
                                            ...
                                            <asp:TextBox ID="shebei4" runat="server" Enabled ="false" Text='<%# Eval("shijijieshu") %>' Visible="false"
                                             Width="100px" Wrap="true" TextMode="MultiLine"   ></asp:TextBox>
                                        </ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="修正日期" ItemStyle-BackColor ="AntiqueWhite" Visible="False" >
                                        <ItemTemplate>
                                            ...
                                            <asp:TextBox ID="shebei5Label5" Enabled ="false"  runat="server" Text='<%# Eval("zhuangtai") %>' Visible="false"
                                                Width="100px"></asp:TextBox>
                                        </ItemTemplate>
                                        <ItemStyle BackColor="AntiqueWhite" />
                                    </asp:TemplateField>
