<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CaseDaiFen22.aspx.cs" Inherits="Case_CaseDaiFen22" %>
    ...
    <asp:TextBox ID="TextBox1" runat="server" Width="111px"></asp:TextBox>
        ...
        <asp:GridView ID="GridView1" runat="server" Width="100%" CssClass="Admin_Table" AutoGenerateColumns="False"
            ...
            <Columns>
                ...
                <asp:BoundField DataField="canyu" HeaderText="参与" HeaderStyle-CssClass="jieshoudate" ItemStyle-CssClass="jieshoudate" >


<HeaderStyle CssClass="jieshoudate"></HeaderStyle>

<ItemStyle CssClass="jieshoudate"></ItemStyle>
                </asp:BoundField>


                <asp:BoundField DataField="dotime" DataFormatString="{0:d}" HeaderText="接收日期" HeaderStyle-CssClass="jieshoudate" ItemStyle-CssClass="jieshoudate" >
...
<ItemStyle CssClass="jieshoudate"></ItemStyle>
                ...
                <asp:TemplateField HeaderText="接收">
                    <ItemTemplate>
                        <asp:LinkButton ID="LinkButton7" runat="server" Text="取消" CommandArgument='<%# Eval("id") %>'
