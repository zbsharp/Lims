<%@ Page Language="C#" AutoEventWireup="true" CodeFile="YiFenYiShou2.aspx.cs" Inherits="Case_YiFenYiShou2" %>
        ...
        <table align="center" border="0" cellpadding="3" cellspacing="1" style="background-color: #b9d8f3"
            ...
            <tr bgcolor="#f4faff">
                <td style="height: 5px">
                    ...
                    <asp:RadioButtonList ID="RadioButtonList1" Visible ="false" runat="server" AutoPostBack="true" RepeatDirection="Horizontal"
                        RepeatLayout="Flow" OnSelectedIndexChanged="RadioButtonList1_SelectedIndexChanged">
                        <asp:ListItem Value="order by convert(datetime,xiadariqi) desc" >按下达日期排序</asp:ListItem>
                        <asp:ListItem Value="order by convert(datetime,wancheng) desc" Selected="True">按恢复日期排序</asp:ListItem>
                    </asp:RadioButtonList>
                </td>
            </tr>
            <tr bgcolor="#f4faff">
                <td style="height: 5px">
                    <asp:GridView ID="GridView1" runat="server" Width="100%" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="" HeaderText="承接部门"  Visible ="false"/>
                ...
                DataNavigateUrlFields="rwbianhao"  Visible ="false"/>
                            ...
                            <asp:HyperLinkField HeaderText="上报" Text="上报" Visible ="false" Target="_blank" DataNavigateUrlFormatString="~/Case/CeShiFeiGc.aspx?bianhao={0}"
                              ...
                              <asp:BoundField DataField="beizhu21" HeaderText="最近一次暂停原因" />
                               <asp:BoundField DataField="wancheng" HeaderText="恢复时间" />
