<%@ Page Language="C#" AutoEventWireup="true" CodeFile="YiFenYiShou4.aspx.cs" MaintainScrollPositionOnPostback ="true"  Inherits="Case_YiFenYiShou4" %>
            ...
            <tr bgcolor="#f4faff">
                <td style="height: 5px">
                    <asp:GridView ID="GridView1" runat="server" Width="100%" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="beizhu3" HeaderText="实际" DataFormatString ="{0:d}" />
                ...
                DataNavigateUrlFields="rwbianhao" />
                          ...
                          <asp:TemplateField HeaderText="操作" Visible ="false" >
                              ...
                              <asp:BoundField DataField="" HeaderText="超期原因"  Visible ="false" />
                              ...
                              <asp:HyperLinkField HeaderText="编辑" Text="编辑" Visible ="false" Target="_blank" DataNavigateUrlFormatString="~/Case/TaskIn1.aspx?tijiaobianhao={0}"
                    DataNavigateUrlFields="bianhao" />
