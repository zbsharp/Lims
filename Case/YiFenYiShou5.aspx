<%@ Page Language="C#" AutoEventWireup="true" CodeFile="YiFenYiShou5.aspx.cs" Inherits="Case_YiFenYiShou5" %>
    ...
    <div>
        ...
        <table align="center" border="0" cellpadding="3" cellspacing="1" style="background-color: #b9d8f3"
            ...
            <tr bgcolor="#f4faff">
                <td style="height: 5px">
                    ...
                    且下达日期： <input id="txFDate" runat="server" class="TxCss" name="txFDate" onclick="popUpCalendar(this,document.forms[0].txFDate,'yyyy-mm-dd')"
        ...
        <input id="txTDate" runat="server" class="TxCss" name="txTDate" onclick="popUpCalendar(this,document.forms[0].txTDate,'yyyy-mm-dd')"
            ...
            onclick="Button1_Click" Text="导出excel" />
                    ...
                    超期原因： <asp:DropDownList ID="DropDownList3" runat="server">
                    </asp:DropDownList>
            ...
            <tr bgcolor="#f4faff">
                <td style="height: 5px">
                    <asp:GridView ID="GridView1" runat="server" Width="100%" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="state" HeaderText="报告状态" Visible="false" />
                ...
                DataNavigateUrlFields="rwbianhao" />
                          ...
                          <asp:TemplateField HeaderText="操作"  Visible ="false"  >
                              ...
                              <asp:BoundField DataField="songjiandate" HeaderText="超期原因" />
