...
public partial class Case_CeShiFeiGcM : System.Web.UI.Page
{
    ...
    protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        {
            Response.Redirect("CeShiFeiSee.aspx?id=" + sid);
        }
    }
    ...
    protected void Bind(string a, string b, int c, string d)
    {
        ...
        {
            case 0:
                sqlstr = "select * from CeShiFei where filltime between '" + ds1 + "' and '" + ds2 + "' order by filltime asc  ";
                break;
            case 1:
                sqlstr = "select * from CeShiFei where filltime between '" + ds1 + "' and '" + ds2 + "'and xiangmu like '%" + ChooseValue + "%' order by filltime asc  ";
                break;
            default:
                sqlstr = "select * from CeShiFei where filltime between '" + ds1 + "' and '" + ds2 + "' order by filltime asc  ";
                break;
    ...
    {
        Response.Redirect("~/Print/Default.aspx");
    }
}