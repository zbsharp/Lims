...
public partial class Case_YiFenYiShou3 : System.Web.UI.Page
{
    ...
    public void Bind(string dd)
    {
        ...
        string str = "select *,(select top 1 pizhundate from baogao2 where tjid=anjianinfo2.rwbianhao) as wancheng3,(select top 1 beizhu2 from zanting2 where rwbianhao=anjianinfo2.rwbianhao and beizhu3='暂停') as beizhu21,chanpinname  as na, xinghaoguige as gg, ziliaostate, kf, xiadariqi  as xiada, shixian  as shixian,yaoqiushixian  as shixian2,(select top 1 state from baogao2 where tjid=anjianinfo2.rwbianhao) as st1,(select top 1 customname from customer where kehuid =anjianinfo2.kehuid) as kehuname from anjianinfo2 where ((state ='完成' or state='暂停' or state='进行中' or state='下达') and  rwbianhao  in (select bianhao from ZhuJianEngineer)) and convert(datetime,xiadariqi) between '" + Convert.ToDateTime(txFDate.Value) + "' and '" + Convert.ToDateTime(txTDate.Value) + "' and " + shwhere + " " + dd + "";
    ...
    protected void Button2_Click(object sender, EventArgs e)
    {
        ...
        if (DropDownList1.SelectedValue != "3")
        {
            if (TextBox1.Text.Trim() == "")
            {
                ...
                if (Session["role"].ToString() == "8" || Session["role"].ToString() == "1" || xian)
                {
                    ...
                    {
                        sqlstr = "select *,(select top 1 pizhundate from baogao2 where tjid=anjianinfo2.rwbianhao) as wancheng3,(select top 1 beizhu2 from zanting2 where rwbianhao=anjianinfo2.rwbianhao and beizhu3='暂停') as beizhu21,chanpinname  as na, xinghaoguige as gg, ziliaostate, kf, xiadariqi  as xiada, shixian  as shixian,yaoqiushixian  as shixian2,(select top 1 state from baogao2 where tjid=anjianinfo2.rwbianhao) as st1,(select top 1 customname from customer where kehuid =anjianinfo2.kehuid) as kehuname from anjianinfo2 where ((state ='下达' or state='进行中') and  rwbianhao  in (select bianhao from ZhuJianEngineer)  " + shic + " )   " + pai + "";

                    }
                    else if (DropDownList1.SelectedValue == "1")
                    {
                        sqlstr = "select *,(select top 1 pizhundate from baogao2 where tjid=anjianinfo2.rwbianhao) as wancheng3,(select top 1 beizhu2 from zanting2 where rwbianhao=anjianinfo2.rwbianhao and beizhu3='暂停') as beizhu21,chanpinname  as na, xinghaoguige as gg, ziliaostate, kf, xiadariqi  as xiada, shixian  as shixian,yaoqiushixian  as shixian2,(select top 1 state from baogao2 where tjid=anjianinfo2.rwbianhao) as st1,(select top 1 customname from customer where kehuid =anjianinfo2.kehuid) as kehuname from anjianinfo2 where ((state='暂停') and  rwbianhao  in (select bianhao from ZhuJianEngineer) " + shic + " )  " + pai + "";

                    }
                    else if (DropDownList1.SelectedValue == "2")
                    {
                        sqlstr = "select *,(select top 1 pizhundate from baogao2 where tjid=anjianinfo2.rwbianhao) as wancheng3,(select top 1 beizhu2 from zanting2 where rwbianhao=anjianinfo2.rwbianhao and beizhu3='暂停') as beizhu21,chanpinname  as na, xinghaoguige as gg, ziliaostate, kf, xiadariqi  as xiada, shixian  as shixian,yaoqiushixian  as shixian2,(select top 1 state from baogao2 where tjid=anjianinfo2.rwbianhao) as st1,(select top 1 customname from customer where kehuid =anjianinfo2.kehuid) as kehuname from anjianinfo2 where ((state='完成') and  rwbianhao  in (select bianhao from ZhuJianEngineer)  " + shic + ")  " + pai + "";

                    }
                    else if (DropDownList1.SelectedValue == "3")
                    {
                        sqlstr = "select *,(select top 1 pizhundate from baogao2 where tjid=anjianinfo2.rwbianhao) as wancheng3,(select top 1 beizhu2 from zanting2 where rwbianhao=anjianinfo2.rwbianhao and beizhu3='暂停') as beizhu21,chanpinname  as na, xinghaoguige as gg, ziliaostate, kf, xiadariqi  as xiada, shixian  as shixian,yaoqiushixian  as shixian2,(select top 1 state from baogao2 where tjid=anjianinfo2.rwbianhao) as st1,(select top 1 customname from customer where kehuid =anjianinfo2.kehuid) as kehuname from anjianinfo2 where ((state ='下达' or state='进行中') and  rwbianhao  in (select bianhao from ZhuJianEngineer)) and (convert(datetime, yaoqiuwanchengriqi) < '" + DateTime.Now.AddDays(-1) + "' " + shic + " ) " + pai + "";

                    }
                    else if (DropDownList1.SelectedValue == "4")
                    {
                        sqlstr = "select *,(select top 1 pizhundate from baogao2 where tjid=anjianinfo2.rwbianhao) as wancheng3,(select top 1 beizhu2 from zanting2 where rwbianhao=anjianinfo2.rwbianhao and beizhu3='暂停') as beizhu21,chanpinname  as na, xinghaoguige as gg, ziliaostate, kf, xiadariqi  as xiada, shixian  as shixian,yaoqiushixian  as shixian2,(select top 1 state from baogao2 where tjid=anjianinfo2.rwbianhao) as st1,(select top 1 customname from customer where kehuid =anjianinfo2.kehuid) as kehuname from anjianinfo2 where ((state ='下达' or state='进行中') and  rwbianhao  in (select bianhao from ZhuJianEngineer)) and (convert(datetime, yaoqiuwanchengriqi) between '" + DateTime.Now + "' and  '" + DateTime.Now.AddDays(4) + "' " + shic + ")   " + pai + "";
                ...
                else
                {
                    ...
                    {
                        sqlstr = "select *,(select top 1 pizhundate from baogao2 where tjid=anjianinfo2.rwbianhao) as wancheng3,(select top 1 beizhu2 from zanting2 where rwbianhao=anjianinfo2.rwbianhao and beizhu3='暂停') as beizhu21,chanpinname  as na, xinghaoguige as gg, ziliaostate, kf, xiadariqi  as xiada, shixian  as shixian,yaoqiushixian  as shixian2,(select top 1 state from baogao2 where tjid=anjianinfo2.rwbianhao) as st1,(select top 1 customname from customer where kehuid =anjianinfo2.kehuid) as kehuname from anjianinfo2 where ((state ='下达' or state='进行中') and  rwbianhao  in (select bianhao from ZhuJianEngineer) and (convert(datetime, yaoqiuwanchengriqi) < '" + DateTime.Now.AddDays(-1) + "') and " + shwhere + "  " + shic + ")  " + pai + "";

                    }
                    else if (DropDownList1.SelectedValue == "4")
                    {
                        sqlstr = "select *,(select top 1 pizhundate from baogao2 where tjid=anjianinfo2.rwbianhao) as wancheng3,(select top 1 beizhu2 from zanting2 where rwbianhao=anjianinfo2.rwbianhao and beizhu3='暂停') as beizhu21,chanpinname  as na, xinghaoguige as gg, ziliaostate, kf, xiadariqi  as xiada, shixian  as shixian,yaoqiushixian  as shixian2,(select top 1 state from baogao2 where tjid=anjianinfo2.rwbianhao) as st1,(select top 1 customname from customer where kehuid =anjianinfo2.kehuid) as kehuname from anjianinfo2 where ((state ='下达' or state='进行中') and  rwbianhao  in (select bianhao from ZhuJianEngineer) and (convert(datetime, yaoqiuwanchengriqi) between '" + DateTime.Now + "' and  '" + DateTime.Now.AddDays(4) + "') and " + shwhere + "  " + shic + ") " + pai + "";
            ...
            else
            {
                if (Session["role"].ToString() == "8" || Session["role"].ToString() == "1" || xian)
                {
                    ...
                    {
                        sqlstr = "select *,(select top 1 pizhundate from baogao2 where tjid=anjianinfo2.rwbianhao) as wancheng3,(select top 1 beizhu2 from zanting2 where rwbianhao=anjianinfo2.rwbianhao and beizhu3='暂停') as beizhu21,chanpinname  as na, xinghaoguige as gg, ziliaostate, kf, xiadariqi  as xiada, shixian  as shixian,yaoqiushixian  as shixian2,(select top 1 state from baogao2 where tjid=anjianinfo2.rwbianhao) as st1,(select top 1 customname from customer where kehuid =anjianinfo2.kehuid) as kehuname from anjianinfo2 where (  rwbianhao  in (select bianhao from ZhuJianEngineer))   and (rwbianhao like '%" + TextBox1.Text.Trim() + "%' or rwbianhao in (select taskid from anjianinfo where bumen like '%" + TextBox1.Text.Trim() + "%') or shenqingbianhao like '%" + TextBox1.Text.Trim() + "%' or shiyanleibie like '%" + TextBox1.Text.Trim() + "%' or kf like '%" + TextBox1.Text.Trim() + "%' or  (weituodanwei like '%" + TextBox1.Text.Trim() + "%') or rwbianhao in (select bianhao from ZhuJianEngineer where name like '%" + TextBox1.Text.Trim() + "%') " + shic + ") " + pai + "";
                    }
                    else
                    {
                        ...
                        else if (DropDownList1.SelectedValue == "3")
                        {
                            ...
                            sqlstr = "select *,(select top 1 pizhundate from baogao2 where tjid=anjianinfo2.rwbianhao) as wancheng3,(select top 1 beizhu2 from zanting2 where rwbianhao=anjianinfo2.rwbianhao and beizhu3='暂停') as beizhu21,chanpinname  as na, xinghaoguige as gg, ziliaostate, kf, xiadariqi  as xiada, shixian  as shixian,yaoqiushixian  as shixian2,(select top 1 state from baogao2 where tjid=anjianinfo2.rwbianhao) as st1,(select top 1 customname from customer where kehuid =anjianinfo2.kehuid) as kehuname from anjianinfo2 where (  rwbianhao  in (select bianhao from ZhuJianEngineer))   and (rwbianhao like '%" + TextBox1.Text.Trim() + "%' or shenqingbianhao like '%" + TextBox1.Text.Trim() + "%' or shiyanleibie like '%" + TextBox1.Text.Trim() + "%' or kf like '%" + TextBox1.Text.Trim() + "%' or rwbianhao in (select taskid from anjianinfo where bumen like '%" + TextBox1.Text.Trim() + "%') or (weituodanwei like '%" + TextBox1.Text.Trim() + "%') or rwbianhao in (select bianhao from ZhuJianEngineer where name like '%" + TextBox1.Text.Trim() + "%')) and " + shic + " " + shwhere1 + " " + pai + "";
                        }
                        else if (DropDownList1.SelectedValue == "4")
                        {

                            sqlstr = "select *,(select top 1 pizhundate from baogao2 where tjid=anjianinfo2.rwbianhao) as wancheng3,(select top 1 beizhu2 from zanting2 where rwbianhao=anjianinfo2.rwbianhao and beizhu3='暂停') as beizhu21,chanpinname  as na, xinghaoguige as gg, ziliaostate, kf, xiadariqi  as xiada, shixian  as shixian,yaoqiushixian  as shixian2,(select top 1 state from baogao2 where tjid=anjianinfo2.rwbianhao) as st1,(select top 1 customname from customer where kehuid =anjianinfo2.kehuid) as kehuname from anjianinfo2 where (  rwbianhao  in (select bianhao from ZhuJianEngineer))   and (rwbianhao like '%" + TextBox1.Text.Trim() + "%' or shenqingbianhao like '%" + TextBox1.Text.Trim() + "%' or shiyanleibie like '%" + TextBox1.Text.Trim() + "%' or kf like '%" + TextBox1.Text.Trim() + "%' or rwbianhao in (select taskid from anjianinfo where bumen like '%" + TextBox1.Text.Trim() + "%') or  (weituodanwei like '%" + TextBox1.Text.Trim() + "%') or rwbianhao in (select bianhao from ZhuJianEngineer where name like '%" + TextBox1.Text.Trim() + "%')) and " + shic + " " + shwhere11 + " " + pai + "";
                        }
                    }
                ...
                else
                {
                    if (DropDownList2.SelectedValue == "或")
                    {
                        sqlstr = "select *,(select top 1 pizhundate from baogao2 where tjid=anjianinfo2.rwbianhao) as wancheng3,(select top 1 beizhu2 from zanting2 where rwbianhao=anjianinfo2.rwbianhao and beizhu3='暂停') as beizhu21,chanpinname  as na, xinghaoguige as gg, ziliaostate, kf, xiadariqi  as xiada, shixian  as shixian,yaoqiushixian  as shixian2,(select top 1 state from baogao2 where tjid=anjianinfo2.rwbianhao) as st1,(select top 1 customname from customer where kehuid =anjianinfo2.kehuid) as kehuname from anjianinfo2 where (   rwbianhao  in (select bianhao from ZhuJianEngineer)  and " + shwhere + " ) and (rwbianhao like '%" + TextBox1.Text.Trim() + "%' or shenqingbianhao like '%" + TextBox1.Text.Trim() + "%' or shiyanleibie like '%" + TextBox1.Text.Trim() + "%' or kf like '%" + TextBox1.Text.Trim() + "%' or rwbianhao in (select taskid from anjianinfo where bumen like '%" + TextBox1.Text.Trim() + "%') or  (weituodanwei like '%" + TextBox1.Text.Trim() + "%') or rwbianhao in (select bianhao from ZhuJianEngineer where name like '%" + TextBox1.Text.Trim() + "%')) " + shic + " " + pai + "";
                    }
                    else
                    {
                        if (DropDownList1.SelectedValue == "0")
                        ...
                        else if (DropDownList1.SelectedValue == "3")
                        {
                            ...
                            sqlstr = "select *,(select top 1 pizhundate from baogao2 where tjid=anjianinfo2.rwbianhao) as wancheng3,(select top 1 beizhu2 from zanting2 where rwbianhao=anjianinfo2.rwbianhao and beizhu3='暂停') as beizhu21,chanpinname  as na, xinghaoguige as gg, ziliaostate, kf, xiadariqi  as xiada, shixian  as shixian,yaoqiushixian  as shixian2,(select top 1 state from baogao2 where tjid=anjianinfo2.rwbianhao) as st1,(select top 1 customname from customer where kehuid =anjianinfo2.kehuid) as kehuname from anjianinfo2 where (   rwbianhao  in (select bianhao from ZhuJianEngineer)  and " + shwhere + " ) and (rwbianhao like '%" + TextBox1.Text.Trim() + "%' or shenqingbianhao like '%" + TextBox1.Text.Trim() + "%' or shiyanleibie like '%" + TextBox1.Text.Trim() + "%' or kf like '%" + TextBox1.Text.Trim() + "%' or rwbianhao in (select taskid from anjianinfo where bumen like '%" + TextBox1.Text.Trim() + "%') or  (weituodanwei like '%" + TextBox1.Text.Trim() + "%') or rwbianhao in (select bianhao from ZhuJianEngineer where name like '%" + TextBox1.Text.Trim() + "%')) and " + shic + " " + shwhere1 + " " + pai + "";
                        }
                        else if (DropDownList1.SelectedValue == "4")
                        {

                            sqlstr = "select *,(select top 1 pizhundate from baogao2 where tjid=anjianinfo2.rwbianhao) as wancheng3,(select top 1 beizhu2 from zanting2 where rwbianhao=anjianinfo2.rwbianhao and beizhu3='暂停') as beizhu21,chanpinname  as na, xinghaoguige as gg, ziliaostate, kf, xiadariqi  as xiada, shixian  as shixian,yaoqiushixian  as shixian2,(select top 1 state from baogao2 where tjid=anjianinfo2.rwbianhao) as st1,(select top 1 customname from customer where kehuid =anjianinfo2.kehuid) as kehuname from anjianinfo2 where (   rwbianhao  in (select bianhao from ZhuJianEngineer)  and " + shwhere + " ) and (rwbianhao like '%" + TextBox1.Text.Trim() + "%' or shenqingbianhao like '%" + TextBox1.Text.Trim() + "%' or shiyanleibie like '%" + TextBox1.Text.Trim() + "%' or kf like '%" + TextBox1.Text.Trim() + "%' or rwbianhao in (select taskid from anjianinfo where bumen like '%" + TextBox1.Text.Trim() + "%') or  (weituodanwei like '%" + TextBox1.Text.Trim() + "%') or rwbianhao in (select bianhao from ZhuJianEngineer where name like '%" + TextBox1.Text.Trim() + "%')) and " + shic + " " + shwhere11 + " " + pai + "";
                        }
                    }
        ...
        {
            sqlstr = "select *,(select top 1 pizhundate from baogao2 where tjid=anjianinfo2.rwbianhao) as wancheng3,(select top 1 beizhu2 from zanting2 where rwbianhao=anjianinfo2.rwbianhao and beizhu3='暂停') as beizhu21,chanpinname  as na, xinghaoguige as gg, ziliaostate, kf, xiadariqi  as xiada, shixian  as shixian,yaoqiushixian  as shixian2,(select top 1 state from baogao2 where tjid=anjianinfo2.rwbianhao) as st1,(select top 1 customname from customer where kehuid =anjianinfo2.kehuid) as kehuname from anjianinfo2 where ((state ='下达' or state='进行中' or state='关闭' or state='完成' or state='暂停' or state='中止') and  rwbianhao  in (select bianhao from ZhuJianEngineer)  " + shic + " )   " + pai + "";
    ...
    protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            //string sjt2 = "";
            //string zts2 = "";
            //searchwhere sx2 = new searchwhere();
            //string sjt1 = sx2.ShiXiao(e.Row.Cells[0].Text, out sjt2, out zts2);

            //int asjt = Convert.ToInt32(sjt2) - 1;
            //int bzts = Convert.ToInt32(zts2) - 1;
