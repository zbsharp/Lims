...
public partial class Case_YiFenYiShou4_WillChaoQi_ : System.Web.UI.Page
{
    ...
    public void Bind(string dd)
    {
        ...
        string chaos = " and state !='暂停' and state !='完成' and baogao='是' and convert(datetime,xiadariqi) >'2013-3-6' and (day1 >= (((yaoqiushixian+shixian+abs(yaoqiushixian-shixian))/2)-3) and day1<=(((yaoqiushixian+shixian+abs(yaoqiushixian-shixian))/2))) ";
    ...
    protected void Button2_Click(object sender, EventArgs e)
    {
        ...
        // string chaos = " and ((convert(datetime,yaoqiuwanchengriqi) < '" + DateTime.Now + "' and state !='完成')  or (rwbianhao in (select rwbianhao from chaoqibiao)) or (convert(datetime,beizhu3) > convert(datetime,yaoqiuwanchengriqi) and state='完成')) and convert(datetime,xiadariqi) < convert(datetime,yaoqiuwanchengriqi)";
        string chaos = " and  baogao='是' and convert(datetime,xiadariqi) >'2013-3-6' and (day1 >= (((yaoqiushixian+shixian+abs(yaoqiushixian-shixian))/2)-3) and day1<=(((yaoqiushixian+shixian+abs(yaoqiushixian-shixian))/2))) ";
        ...
        else
        {
            if (Session["role"].ToString() == "8" || Session["role"].ToString() == "1" || xian)
            {
                ...
                {
                    sqlstr = "select *,(select top 1 pizhundate from baogao2 where tjid=anjianinfo2.rwbianhao) as wancheng3, chanpinname  as na, xinghaoguige as gg, ziliaostate, kf, xiadariqi  as xiada, shixian  as shixian,yaoqiushixian  as shixian2  from anjianinfo2 where   (rwbianhao like '%" + TextBox1.Text.Trim() + "%' or rwbianhao in (select taskid from anjianinfo where bumen like '%" + TextBox1.Text.Trim() + "%') or shenqingbianhao like '%" + TextBox1.Text.Trim() + "%' or shiyanleibie like '%" + TextBox1.Text.Trim() + "%' or kf like '%" + TextBox1.Text.Trim() + "%' or  (weituodanwei like '%" + TextBox1.Text.Trim() + "%') or rwbianhao in (select bianhao from ZhuJianEngineer where name like '%" + TextBox1.Text.Trim() + "%') " + chaos + "   " + shic + ") " + pai + "";
                }
                else
                {
                    ...
                    if (DropDownList1.SelectedValue == "0")
                    {
                        ...
                        sqlstr = "select *,(select top 1 pizhundate from baogao2 where tjid=anjianinfo2.rwbianhao) as wancheng3, chanpinname  as na, xinghaoguige as gg, ziliaostate, kf, xiadariqi  as xiada, shixian  as shixian,yaoqiushixian  as shixian2  from anjianinfo2 where  (rwbianhao like '%" + TextBox1.Text.Trim() + "%' or shenqingbianhao like '%" + TextBox1.Text.Trim() + "%' or rwbianhao in (select taskid from anjianinfo where bumen like '%" + TextBox1.Text.Trim() + "%') or shiyanleibie like '%" + TextBox1.Text.Trim() + "%' or kf like '%" + TextBox1.Text.Trim() + "%' or  (weituodanwei like '%" + TextBox1.Text.Trim() + "%') or rwbianhao in (select bianhao from ZhuJianEngineer where name like '%" + TextBox1.Text.Trim() + "%')) and (state='下达' or state='进行中'  ) " + chaos + "   " + shic + " " + pai + "";
                    }
                    else if (DropDownList1.SelectedValue == "1")
                    {

                        sqlstr = "select *,(select top 1 pizhundate from baogao2 where tjid=anjianinfo2.rwbianhao) as wancheng3, chanpinname  as na, xinghaoguige as gg, ziliaostate, kf, xiadariqi  as xiada, shixian  as shixian,yaoqiushixian  as shixian2  from anjianinfo2 where  (rwbianhao like '%" + TextBox1.Text.Trim() + "%' or shenqingbianhao like '%" + TextBox1.Text.Trim() + "%' or shiyanleibie like '%" + TextBox1.Text.Trim() + "%' or rwbianhao in (select taskid from anjianinfo where bumen like '%" + TextBox1.Text.Trim() + "%') or kf like '%" + TextBox1.Text.Trim() + "%' or (weituodanwei like '%" + TextBox1.Text.Trim() + "%') or rwbianhao in (select bianhao from ZhuJianEngineer where name like '%" + TextBox1.Text.Trim() + "%')) and (state='暂停' ) " + chaos + "   " + shic + " " + pai + "";
                    }
                    else if (DropDownList1.SelectedValue == "2")
                    {

                        sqlstr = "select *,(select top 1 pizhundate from baogao2 where tjid=anjianinfo2.rwbianhao) as wancheng3, chanpinname  as na, xinghaoguige as gg, ziliaostate, kf, xiadariqi  as xiada, shixian  as shixian,yaoqiushixian  as shixian2  from anjianinfo2 where  (rwbianhao like '%" + TextBox1.Text.Trim() + "%' or shenqingbianhao like '%" + TextBox1.Text.Trim() + "%' or shiyanleibie like '%" + TextBox1.Text.Trim() + "%' or kf like '%" + TextBox1.Text.Trim() + "%' or rwbianhao in (select taskid from anjianinfo where bumen like '%" + TextBox1.Text.Trim() + "%') or  (weituodanwei like '%" + TextBox1.Text.Trim() + "%') or rwbianhao in (select bianhao from ZhuJianEngineer where name like '%" + TextBox1.Text.Trim() + "%')) and (state='完成' )" + chaos + "   " + shic + "  " + pai + "";
                    }
            ...
            else
            {
                if (DropDownList2.SelectedValue == "或")
                {
                    sqlstr = "select *,(select top 1 pizhundate from baogao2 where tjid=anjianinfo2.rwbianhao) as wancheng3, chanpinname  as na, xinghaoguige as gg, ziliaostate, kf, xiadariqi  as xiada, shixian  as shixian,yaoqiushixian  as shixian2  from anjianinfo2 where  " + shwhere + " ) and (rwbianhao like '%" + TextBox1.Text.Trim() + "%' or shenqingbianhao like '%" + TextBox1.Text.Trim() + "%' or shiyanleibie like '%" + TextBox1.Text.Trim() + "%' or kf like '%" + TextBox1.Text.Trim() + "%' or rwbianhao in (select taskid from anjianinfo where bumen like '%" + TextBox1.Text.Trim() + "%') or  (weituodanwei like '%" + TextBox1.Text.Trim() + "%') or rwbianhao in (select bianhao from ZhuJianEngineer where name like '%" + TextBox1.Text.Trim() + "%')) " + chaos + "   " + shic + " " + pai + "";
                }
                else
                {
                    if (DropDownList1.SelectedValue == "0")
