...
public partial class Case_YiFenYiShou2 : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Session["role"].ToString() == "8" || Session["role"].ToString() == "1" || Session["role"].ToString() == "3" || xian)
        {
            ...
            shwhere = "1=1 and wancheng between '" + Convert.ToDateTime(DateTime.Now.AddDays(-1).ToShortDateString()) + "' and '" + DateTime.Now + "'";
        ...
        {
            shwhere = " ( rwbianhao in (select bianhao from ZhuJianEngineer where name='" + Session["UserName"].ToString() + "') and wancheng between '" + Convert.ToDateTime(DateTime.Now.AddDays(-1).ToShortDateString()) + "' and '" + DateTime.Now + "')";
    ...
    public void Bind(string dd)
    {
        ...
        string str = "select *,(select top 1 beizhu2 from zanting2 where rwbianhao=anjianinfo2.rwbianhao and beizhu3='暂停') as beizhu21,chanpinname  as na, xinghaoguige as gg, ziliaostate, kf, xiadariqi  as xiada, shixian  as shixian,yaoqiushixian  as shixian2,(select top 1 state from baogao2 where tjid=anjianinfo2.rwbianhao) as st1,(select top 1 customname from customer where kehuid =anjianinfo2.kehuid) as kehuname from anjianinfo2 where (state ='进行中' and  rwbianhao  in (select bianhao from ZhuJianEngineer)) and " + shwhere + " " + dd + "";
    ...
    protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            e.Row.Cells[20].Text = SubStr(e.Row.Cells[20].Text, 15);
    ...
    protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        if (e.CommandName == "cancel1")
        {
                ...
                sqlx = "update anjianinfo2 set wancheng='1900-1-1' where rwbianhao='"+sid+"'";
