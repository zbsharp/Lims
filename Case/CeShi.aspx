<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CeShi.aspx.cs" Inherits="Case_CeShi" %>
           ...
           工程管理 》》工程测试状态</div>
                ...
                <table class="Admin_Table"
                    ...
                    <tr>
                        ...
                        <td align ="left" >
                            <span style="font-size: 13pt; vertical-align: middle; color: red">
                                <asp:TextBox ID="TextBox3" runat="server" Width="140px"  Enabled ="false" ReadOnly="True"></asp:TextBox></span>
                        </td>
                    </tr>
                   ...
                   <tr  style ="display :none;">
                    ...
                    <tr>
                        <td  colspan="2" align="center">
                            <asp:Button ID="Button1" runat="server" OnClick="Button1_Click" Text="通过" />
                    ...
                    <tr>
                        <td  colspan="4">
                                    ...
                                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="id"
                                        ...
                                        <Columns>
                                            <asp:BoundField DataField="shenhebianhao" HeaderText="任务编号" ReadOnly="true" />
