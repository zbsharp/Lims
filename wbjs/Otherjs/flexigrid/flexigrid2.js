...
(function($) {
    ...
    $.addFlex = function(t, p) {
        ...
        var g = {
            ...
            dragStart: function(dragtype, e, obj) { //default drag function start
                ...
                else if (dragtype == 'vresize') //table resize
                {
                    ...
                    //window.status = "h: "+p.height+", sy: "+ e.pageY+ ", w: "+ p.width+ ", sx: " + e.pageX+", hgo: "+ hgo;
        ...
        if (p.colModel) {
            ...
            thead = t.firstChild; //TBODY
            tr = t.firstChild.firstChild; //TR

            for (i = 0; i < tr.childNodes.length; i++) {
                var th = tr.childNodes[i];
                if (th.name && th.sortable) { $(th).attr('abbr', th.name); }
        ...
        //init divs
        g.gDiv = document.createElement('div'); //create global container 大容器
        g.mDiv = document.createElement('div'); //create title container    标题
        ...
        // add column control 显示/隐藏列的div 控制
        if ($('th', g.hDiv).length) {
