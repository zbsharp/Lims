<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InvoiceAdd3.aspx.cs" Inherits="Income_InvoiceAdd3" %>
...
<body>
    ...
    <asp:TextBox ID="TextBox1" runat="server" Enabled ="false" ></asp:TextBox>
               ...
               <td>
                   保存：</td>
               <td>
                            <asp:Button ID="Button3" runat="server" CssClass="BnCss" Text="修改保存" OnClick="Button3_Click" />
              </td>
            </tr>
