...
public partial class Income_InvoiceAdd2 : System.Web.UI.Page
{
    ...
    public void Bind()
    {
        SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings["DB"].ConnectionString);
        con.Open();
        string sql = "select * from CeShiFeiKf  where kehuid='" + kehuid + "'  and (shoufeibianhao='" + ran + "' or shoufeibianhao='') and taskid in (select taskid from ceshifeikf where shoufeibianhao='" + ran + "') order by filltime desc";
    ...
    protected void Button3_Click(object sender, EventArgs e)
    {
        ...
        string sql5 = "select * from ceshifeikf where shoufeibianhao='" + ran + "'";
        ...
        else
        {
            dr5.Close();
            string invoiceid = "";
            string sql6 = "select id from invoice where inid='"+ran+"'";
            SqlCommand cmd6 = new SqlCommand(sql6,con5);
            SqlDataReader dr6 = cmd6.ExecuteReader();
            if (dr6.Read())
            {
                invoiceid = dr6["id"].ToString();
            }
    ...
    protected void dele(string idd)
    {
        string id = idd;
        string shoufeiid = "";
        string hesuan = "";
