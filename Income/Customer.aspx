<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Customer.aspx.cs" Inherits="Income_Customer" %>
        ...
        <tr>
            <td style="padding-right: 0px; padding-left: 0px; padding-bottom: 0px; padding-top: 0px;"
                ...
                <asp:Panel runat="server" ID="fixedheader">
                    ...
                    HeaderText="" Text="查看客户" Target="_blank" />
                            <asp:HyperLinkField DataNavigateUrlFields="kehuid" DataNavigateUrlFormatString="~/Quotation/QuotationAdd1.aspx?kehuid={0}&&fast=1"
                                HeaderText="" Text="客户报价" Target="_blank" />


                                <asp:HyperLinkField DataNavigateUrlFields="kehuid" DataNavigateUrlFormatString="~/Case/KuaiDiAdd.aspx?kehuid={0}"
                                HeaderText="" Text="快递登记" Target="_blank" />
