...
public partial class Income_KeHu : System.Web.UI.Page
{
    ...
    /// 插入数据到数据库
    /// </summary>
    public void Add(string a, string b, string c, string d, string f, string p5)
    {


        SqlConnection con1 = new SqlConnection(ConfigurationManager.ConnectionStrings["DB"].ConnectionString);
        con1.Open();
        string sql2 = "select * from Table1 where bianhao='" + a.Trim() + "'";
        ...
        else
        {
            ...
            string hh = "insert into Table1 values('" + a.Trim() + "','" + b.Trim() + "','" + Session["UserName"].ToString() + "','" + DateTime.Now.Date + "','" + p5 + "')";
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        string sql = "delete from table1 where pici= '" + a + "' and name='" + Session["UserName"].ToString() + "'";
    ...
    protected void GridView1_RowDeleting(object sender, GridViewDeleteEventArgs e)
    {
        ...
        string sql = "delete from Table1 where id='" + id + "' and name='" + Session["UserName"].ToString() + "' ";
        SqlCommand cmd = new SqlCommand(sql, con1);
        cmd.ExecuteNonQuery();
    ...
    {
        string sql = "select * from Table1 where kehuname like '%" + TextBox2.Text + "%' order by id desc";
