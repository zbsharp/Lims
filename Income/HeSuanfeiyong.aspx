<%@ Page Language="C#" AutoEventWireup="true" CodeFile="HeSuanfeiyong.aspx.cs" Inherits="Income_HeSuanfeiyong" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <asp:DropDownList ID="drop_ceshifeikf" runat="server">
            <asp:ListItem Selected="True"></asp:ListItem>
            <asp:ListItem>已核算</asp:ListItem>
            <asp:ListItem>未核算</asp:ListItem>
        </asp:DropDownList>
        <asp:DropDownList ID="drop_affirm" runat="server">
            <asp:ListItem></asp:ListItem>
            <asp:ListItem Value="否">待确认</asp:ListItem>
