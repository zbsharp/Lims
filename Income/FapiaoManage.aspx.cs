...
public partial class CCSZJiaoZhun_htw_FapiaoManage : System.Web.UI.Page
{
    private int _i = 0;
    ...
    protected void TimeBind(string a, string b, int c, string d)
    {
        ...
        switch (ChooseID)
        {
            ...
            case 1:
                ...
                break;
            case 2:
                sqlstr = "select * from FaPiao where filltime between '" + ds1 + "' and '" + ds2 + "' and daid = '" + ChooseValue + "' order by id asc";
                break;
            default:
                sqlstr = "select * from FaPiao where filltime between '" + ds1 + "' and '" + ds2 + "' order by id asc";
                break;
    ...
    protected void Bind1()
    {
        ...
        string sql = "select * from FaPiao order by id asc";
