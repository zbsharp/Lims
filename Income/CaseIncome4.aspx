<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CaseIncome4.aspx.cs" Inherits="Income_CaseIncome4" %>
    ...
    <div class="Body_Title">
     ...
     <fieldset>
        <legend style="color: Red">应收款项目</legend>
                    ...
                    <ItemTemplate><asp:LinkButton ID="LinkButton1" runat="server" Text="关闭" Visible ="false"  CommandArgument='<%# Eval("rwbianhao") %>'
                            CommandName="xiada1"></asp:LinkButton>|| <asp:LinkButton ID="LinkButton4" Visible ="false" runat="server" Text="打开" CommandArgument='<%# Eval("rwbianhao") %>'
                            CommandName="xiada4"></asp:LinkButton>||
                        <span style="cursor: hand;
                                                    color: Blue;" onclick="window.open('../Case/CeShiFeiKf.aspx?bianhao=<%#Eval("bianhao") %>&&baojiaid=<%#Eval("baojiaid") %>&&kehuid=<%#Eval("kehuid") %>')">
                                                    <asp:Label ID="Label1" runat="server" Text="查看费用"></asp:Label></span>|| <span style="cursor: hand;
