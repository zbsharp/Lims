<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FapiaoManageKeFu.aspx.cs" Inherits="Income_FapiaoManageKeFu" %>
        ...
        <input id="txTDate" runat="server" class="TxCss" name="txTDate" onclick="new Calendar().show(this.form.txTDate);"
            style="width: 90px" type="text" visible="true" />
                <asp:DropDownList ID="DropDownList1" runat="server">
                    ...
                    <asp:ListItem Value="1">发票抬头</asp:ListItem>
                    <asp:ListItem Value="2">凭证编号</asp:ListItem>
                    <asp:ListItem Value="3">发票号码</asp:ListItem>
                </asp:DropDownList>
                    ...
                    <ContentTemplate>
                        <asp:GridView ID="GridView1" runat="server" Width="100%" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="sid" HeaderText="凭证号" />
                               
                                
                         
                                <asp:TemplateField HeaderText="明细">
                                    <ItemTemplate>
                                        <span style="cursor: hand; color: Blue;" onclick="window.open('FapiaoSee2.aspx?id=<%#Eval("id") %>','test','dialogWidth=850px;DialogHeight=360px;status:no;help:no;resizable:yes; dialogTop:120px;edge:raised;')">
