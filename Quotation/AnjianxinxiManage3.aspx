<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AnjianxinxiManage3.aspx.cs" Inherits="Quotation_AnjianxinxiManage3" %>
...
<body>
    <form name="form1" runat="server" id="form1">
        ...
        <div>
            ...
            &nbsp; 委托单位：<asp:TextBox ID="TextBox1" runat="server" Width="111px"></asp:TextBox>
            ...
            <asp:GridView ID="GridView1" runat="server" Width="100%" AutoGenerateColumns="False"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="shenqingbianhao" HeaderText="申请编号" Visible="False" />


                    <asp:HyperLinkField HeaderText="报价编号" DataTextField="baojiaid" DataNavigateUrlFormatString="~/Print/QuoPrint.aspx?baojiaid={0}&&customerid={1}"
                    ...
                    <asp:HyperLinkField HeaderText="协议书" Text="编辑" Target="_blank" DataNavigateUrlFormatString="AnjianxinxiSee.aspx?id={0}"
                        DataNavigateUrlFields="bianhao" />
                    <asp:HyperLinkField HeaderText="项目信息" Text="查看" Target="_blank" DataNavigateUrlFormatString="QuotationApp.aspx?baojiaid={0}&&kehuid={1}"
                        DataNavigateUrlFields="baojiaid,kehuid" />
                    <asp:HyperLinkField HeaderText="协议书" Text="打印" Target="_blank" DataNavigateUrlFormatString="~/Print/PrintWeiTuo.aspx?bianhao={0}"
                        DataNavigateUrlFields="bianhao" />
                    <asp:HyperLinkField HeaderText="操作" Text="受理" Target="_blank" DataNavigateUrlFormatString="~/Case/TaskIn.aspx?tijiaobianhao={0}"
                        DataNavigateUrlFields="bianhao" />
                    <asp:TemplateField HeaderText="取消" Visible="false">
                        <ItemTemplate>
                            <asp:LinkButton ID="LinkButton5" runat="server" Text="取消" CommandArgument='<%# Eval("bianhao") %>'
