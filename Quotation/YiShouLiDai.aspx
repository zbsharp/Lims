<%@ Page Language="C#" AutoEventWireup="true" CodeFile="YiShouLiDai.aspx.cs" Inherits="Quotation_YiShouLiDai" %>
...
<body>
    ...
    <div>
        <div class="Body_Title">
            <asp:Label ID="Label1" runat="server" Text="业务管理 》》待核算任务(已完成且未核算的任务列表)"></asp:Label></div>
        
        是否核算：<asp:DropDownList ID="DropDownList2" runat="server">
        ...
        <asp:GridView ID="GridView1" runat="server" Width="100%" AutoGenerateColumns="False"
           ...
           <%--    <asp:HyperLinkField Text="查看" HeaderText="工程师" Target="button" DataNavigateUrlFormatString="~/Case/AnJianInFo.aspx?xiangmuid={0}&&bumen=&&id={1}"
               ...
               <asp:BoundField DataField="beizhu3" HeaderText="完成日期" />
                   ...
                   <asp:BoundField DataField="shiyanleibie" HeaderText="检验类别" />
                ...
                <asp:HyperLinkField HeaderText="样品" Text="样品" Target="_blank" Visible ="false"   DataNavigateUrlFormatString="~/YangPin/YangPinAdd.aspx?baojiaid={0}&amp;&amp;kehuid={1}&bianhao={2}"
                    ...
                    DataNavigateUrlFields="bianhao" />
                     ...
                     <asp:HyperLinkField HeaderText="编辑" Visible ="false"  Text="编辑" Target="_blank" DataNavigateUrlFormatString="~/Case/TaskIn1.aspx?tijiaobianhao={0}"
                    DataNavigateUrlFields="bianhao" />
                 ...
                 <asp:TemplateField HeaderText="取消"  Visible ="false" >
                    ...
                    <asp:HyperLinkField HeaderText="上传收费" Text="上传收费" Target="_blank"  DataNavigateUrlFormatString="~/Case/UploadFile.aspx?id={0}&&baojiaid={1}"
