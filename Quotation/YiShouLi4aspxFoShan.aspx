<%@ Page Language="C#" AutoEventWireup="true" CodeFile="YiShouLi4aspxFoShan.aspx.cs" Inherits="Quotation_YiShouLi4aspxFoShan" %>
    ...
    <div>
        ...
        <asp:GridView ID="GridView1" runat="server" Width="100%" AutoGenerateColumns="False"
            ...
            <Columns>
                ...
                <asp:BoundField DataField="state1" DataFormatString ="{0:d}" HeaderText="状态" />
                <asp:HyperLinkField HeaderText="草本报告" Text="草本报告" Target="_blank" DataNavigateUrlFormatString="~/Report/BaoGaoFirstUpLoadShenHe22.aspx?taskid={0}"
                                DataNavigateUrlFields="rwbianhao" />

                            

                                 <asp:HyperLinkField HeaderText="正式报告" Text="正式报告" Target="_blank" DataNavigateUrlFormatString="~/Report/BaoGaoShenPi22.aspx?taskid={0}&&pp=1"
                                DataNavigateUrlFields="rwbianhao" />
            
                <asp:BoundField DataField="" HeaderText="工程师" />
                <asp:BoundField DataField="kf" HeaderText="项目经理" />
                 <asp:BoundField DataField="daoz" HeaderText="收费情况" />
                    ...
                    DataNavigateUrlFields="bianhao" />
                     ...
                     <asp:HyperLinkField HeaderText="下载收费单" Text="下载收费单" Target="_blank"  DataNavigateUrlFormatString="~/Case/UploadFile.aspx?id={0}&&baojiaid={1}"
