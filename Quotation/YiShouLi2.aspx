<%@ Page Language="C#" AutoEventWireup="true" CodeFile="YiShouLi2.aspx.cs" Inherits="Quotation_YiShouLi2" %>
        ...
        <asp:GridView ID="GridView1" runat="server" Width="100%" AutoGenerateColumns="False"
            ...
            <Columns>
                ...
                <asp:BoundField DataField="weituo" HeaderText="委托方" />
                 ...
                 <asp:BoundField DataField="kehu" HeaderText="实际客户" />
                ...
                <asp:HyperLinkField HeaderText="分派客服" Text="分派客服" Target="_blank" DataNavigateUrlFormatString="~/Case/FenPaiKeFu.aspx?xiangmuid={0}"
                    DataNavigateUrlFields="taskno" />
                <asp:BoundField DataField="kf" HeaderText="客服" />

                <asp:BoundField DataField="state1" HeaderText="状态" />
                 <asp:BoundField DataField="xiangmu" HeaderText="试验类别" />
            </Columns>
