<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AnjianxinxiSee.aspx.cs" Inherits="AnjianxinxiSee" %>
            ...
            <table align="center" class="Admin_Table" width="100%">
                <tr>
                    <td colspan="2" style="text-align: left">
                        ...
                        <asp:Button ID="Button1" runat="server" CssClass="BnCss"
                            Text="保存" OnClick="Button1_Click" CausesValidation="true" />

                        <asp:Button ID="Button3" runat="server" Text="打印" OnClick="Button3_Click" Visible="False" />
                    ...
                    <td colspan="2" style="text-align: right">
                        ...
                        <asp:Button ID="Button5" runat="server" Text="受理" Visible="false" OnClick="Button5_Click" />
                        <asp:Button ID="Button2" runat="server" Text="退回" OnClick="Button2_Click" Visible="false" />
