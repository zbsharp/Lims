...
public partial class Quotation_YiShouLiYanPing : System.Web.UI.Page
{
    private int _i = 0;
    protected string ys = "";
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        strSql2.Append("* from Anjianinfo2 where baojiaid not like 'B%' and kehuid not like 'D%' and rwbianhao not like 'D%'");
        ...
        strSql.Append("* from Anjianinfo2 where baojiaid not like 'B%' and kehuid not like 'D%' and rwbianhao not like 'D%'");
    ...
    protected void Button2_Click(object sender, EventArgs e)
    {
        ...
        if (this.TextBox1.Text.Trim() == "")
        {
            ...
            {
                dd = "   (shenqingbianhao like '%ccc10%' or shenqingbianhao like '%-1001-%' or shenqingbianhao like '%CQC004014%') and   convert(datetime,xiadariqi) between '" + Convert.ToDateTime(txFDate.Value) + "' and '" + Convert.ToDateTime(txTDate.Value).AddHours(23) + "'";

            }

            else if (DropDownList1.SelectedValue == "b4")
            {
                dd = "( (b3 ='医疗电子'))  and  (  convert(datetime,xiadariqi) between '" + Convert.ToDateTime(txFDate.Value) + "' and '" + Convert.ToDateTime(txTDate.Value).AddHours(23) + "')";

            }
            else
            {
                dd = "   convert(datetime,xiadariqi) between '" + Convert.ToDateTime(txFDate.Value) + "' and '" + Convert.ToDateTime(txTDate.Value).AddHours(23) + "'";
            }
            Response.Redirect("YiShouLiYanPing.aspx?minid=" + Server.UrlEncode(dd) + "&&ti1=" + DropDownList1.SelectedValue + "&&ti2=" + TextBox1.Text.Trim() + "&&ti3=" + txFDate.Value + "&&ti4=" + txTDate.Value);
        ...
        else
        {
            ...
            {
                dd = "( fukuandanwei like '%" + ChooseValue + "%' or weituodanwei like '%" + ChooseValue + "%' or shengchandanwei like '%" + ChooseValue + "%' or kehuid in (select kehuid from customer where customname like '%" + ChooseValue + "%'))  and  (  convert(datetime,xiadariqi) between '" + Convert.ToDateTime(txFDate.Value) + "' and '" + Convert.ToDateTime(txTDate.Value).AddHours(23) + "')";
            ...
            {
                dd = "( " + DropDownList1.SelectedValue + " like '%" + ChooseValue + "%' and   convert(datetime,xiadariqi) between '" + Convert.ToDateTime(txFDate.Value) + "' and '" + Convert.ToDateTime(txTDate.Value).AddHours(23) + "')";
    ...
    protected void TimeBind(string a, string b)
    {
        ...
        if (DropDownList1.SelectedValue == "kehuname")
        {
            sqlstr = strSql2 + " and  ( fukuan like '%" + ChooseValue + "%' or weituo like '%" + ChooseValue + "%' or shenchan like '%" + ChooseValue + "%' or kehuid in (select kehuid from customer where customname like '%" + ChooseValue + "%')) and   convert(datetime,xiadariqi) between '" + Convert.ToDateTime(txFDate.Value) + "' and '" + Convert.ToDateTime(txTDate.Value).AddHours(23) + "' order by substring(rwbianhao,4,5) desc ";

        }
        else if (DropDownList1.SelectedValue == "b3")
        {
            sqlstr = strSql2 + " and  ((shenqingbianhao like '%ccc10%' or shenqingbianhao like '%-1001-%' or shenqingbianhao like '%CQC004014%')) and   convert(datetime,xiadariqi) between '" + Convert.ToDateTime(txFDate.Value) + "' and '" + Convert.ToDateTime(txTDate.Value).AddHours(23) + "' order by substring(rwbianhao,4,5) desc ";

        }
        else
        {
            sqlstr = strSql2 + " and " + DropDownList1.SelectedValue + " like '%" + ChooseValue + "%' and  convert(datetime,xiadariqi) between '" + Convert.ToDateTime(txFDate.Value) + "' and '" + Convert.ToDateTime(txTDate.Value).AddHours(23) + "' order by substring(rwbianhao,4,5) desc";
    ...
    protected void TimeBind()
    {
        ...
        sqlstr = strSql + "and  convert(datetime,xiadariqi) between '" + Convert.ToDateTime(txFDate.Value) + "' and '" + Convert.ToDateTime(txTDate.Value).AddHours(23) + "' order by substring(rwbianhao,4,5) desc ";

        if (minId != "0")
        {
            sqlstr = strSql2 + "and  " + minId + " and  convert(datetime,xiadariqi) between '" + Convert.ToDateTime(txFDate.Value) + "' and '" + Convert.ToDateTime(txTDate.Value).AddHours(23) + "' order by substring(rwbianhao,4,5) desc ";
