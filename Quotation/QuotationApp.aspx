<%@ Page Language="C#" AutoEventWireup="true" CodeFile="QuotationApp.aspx.cs" Inherits="Quotation_QuotationApp" %>
...
<body>
    <form id="form1" runat="server">
                    ...
                    <td align="center" colspan="4">
                        <asp:GridView ID="GridView2" runat="server" Width="100%" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="total" HeaderText="实际价格" ItemStyle-CssClass="shijibaojia" HeaderStyle-CssClass="shijibaojia">
                                    <HeaderStyle CssClass="shijibaojia"></HeaderStyle>

                                    <ItemStyle CssClass="shijibaojia"></ItemStyle>
                                </asp:BoundField>
                                ...
                                <asp:BoundField DataField="cpid" HeaderText="产品id" />
                                <%--                                <asp:BoundField DataField="xiaoid" HeaderText="原始项目id" />--%>
                            </Columns>
                            <EmptyDataTemplate>
                                <asp:Label ID="Label2" runat="server" ForeColor="Red" Text="暂时未有数据"></asp:Label>
                            </EmptyDataTemplate>
        ...
        <fieldset>
            <legend style="color: Red">系统基准项目对照</legend>
            <table class="Admin_Table">
                <tr>
                    <td align="center" colspan="4">
                        <asp:GridView ID="GridView6" runat="server" Width="100%" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="leibiename" HeaderText="对应部门" />
                                <asp:BoundField DataField="chanpinname" HeaderText="二级分类" />
                                <asp:BoundField DataField="neirong" HeaderText="测试项目" />
                                <asp:BoundField DataField="biaozhun" HeaderText="标准" />
                                <asp:BoundField DataField="yp" HeaderText="样品" />
                                <asp:BoundField DataField="shoufei" HeaderText="标准报价" />
                                <%--                                <asp:BoundField DataField="id" HeaderText="原始项目id" />--%>
                            </Columns>
                            <EmptyDataTemplate>
                                <asp:Label ID="Label2" runat="server" ForeColor="Red" Text="暂时未有数据"></asp:Label>
                            </EmptyDataTemplate>
        ...
        <fieldset>
            ...
            <table class="Admin_Table">
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="baojiabeizhu_txt" Enabled="false" runat="server" TextMode="MultiLine" Width="430px"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td>优惠后金额:</td>
                    <td>
                        <asp:TextBox ID="txt_coupon" runat="server" Enabled="false"></asp:TextBox></td>
                    <td>币种:</td>
                    <td>
                        <asp:TextBox ID="txt_currency" runat="server" Enabled="false"></asp:TextBox></td>
                </tr>
                <tr>
                    <td>是否含税: </td>
                    <td>
                        <asp:TextBox ID="txt_vat" runat="server" Enabled="false"></asp:TextBox>
                    </td>
                    <td>税金: </td>
                    <td>
                        <asp:TextBox ID="txt_taxes" runat="server" Enabled="false"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td>扩展费:</td>
                    <td>
                        <asp:TextBox ID="txt_kuozhanfei" runat="server" Enabled="false"></asp:TextBox>
                    </td>
                </tr>
            </table>
        </fieldset>
        <fieldset>
            ...
            <table class="Admin_Table">
                ...
                <tr>
                    <td colspan="4">账户版本:<asp:DropDownList ID="DropDownList3" runat="server" Enabled="false">
                    </asp:DropDownList></td>
                </tr>
            </table>
        </fieldset>
