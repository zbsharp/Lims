<%@ Page Language="C#" AutoEventWireup="true" CodeFile="QuoKaiAn2.aspx.cs" Inherits="Quotation_QuoKaiAn2" %>
...
<body>
    ...
    查询条件：&nbsp;<asp:DropDownList
        ...
        <asp:CheckBoxList ID="CheckBoxList1" runat="server" RepeatDirection="Horizontal" 
            ...
            onclick="Button1_Click" Text="分派任务" />
                      ...
                      <asp:CheckBox ID="CheckBox2" runat="server" AutoPostBack="True" OnCheckedChanged="CheckBox2_CheckedChanged"
                        ...
                        <asp:GridView ID="GridView1" runat="server" Width="100%" CssClass="Admin_Table"
                               AutoGenerateColumns="False" DataKeyNames="id"   OnRowDataBound="GridView1_RowDataBound">
                                ...
                                <asp:BoundField DataField="feiyong" HeaderText="费用"  Visible ="false"/>
                                <asp:BoundField DataField="zhekou" HeaderText="折扣" Visible ="false"/>
                                <asp:BoundField DataField="shuliang" HeaderText="数量" />
                                <asp:BoundField DataField="beizhu" HeaderText="备注" />
                                 <asp:BoundField DataField="jishuyaoqiu" HeaderText="技术要求" />
                                <asp:BoundField DataField="tijiaobiaozhi" HeaderText="提交标志" />
                                <asp:BoundField DataField="tijiaoname" HeaderText="提交人" />
                                <asp:BoundField DataField="tijiaotime" HeaderText="提交时间" />
                                  <asp:HyperLinkField Text="上传" HeaderText="附件" Target="button" DataNavigateUrlFormatString="~/Case/UploadFile.aspx?id={0}"
