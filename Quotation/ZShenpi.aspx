<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ZShenpi.aspx.cs" Inherits="Quotation_ZShenpi" %>
    ...
    <form id="form1" runat="server">
        ...
        <asp:GridView ID="GridView1" runat="server" Width="100%" CssClass="Admin_Table"
            ...
            <Columns>
                ...
                <asp:HyperLinkField HeaderText="预览" Text="预览" DataNavigateUrlFormatString="~/Print/QuoPrint.aspx?baojiaid={0}&&customerid={1}&&pi=1"
