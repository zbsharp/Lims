<%@ Page Language="C#" AutoEventWireup="true" CodeFile="QuotationHuiqian2.aspx.cs"  Inherits="Quotation_QuotationHuiqian2" %>
           ...
           <asp:BoundField DataField="baojiaid" HeaderText="报价编号"/>
            ...
            <asp:HyperLinkField HeaderText="报价单"  Text ="查看" DataNavigateUrlFormatString="~/Print/QuoPrint.aspx?baojiaid={0}&&customerid={1}"
                ...
                DataNavigateUrlFields="baojiaid,kehuid" />
                 ...
                 <asp:HyperLinkField  HeaderText="报价单" Text ="编辑" Target="button" DataNavigateUrlFormatString="~/Quotation/QuotationAdd.aspx?baojiaid={0}&amp;&amp;kehuid={1}&&idf=8"
                DataNavigateUrlFields="baojiaid,kehuid" />
