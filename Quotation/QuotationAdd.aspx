<%@ Page Language="C#" AutoEventWireup="true" CodeFile="QuotationAdd.aspx.cs" ValidateRequest="false" MaintainScrollPositionOnPostback="true"
    Inherits="Quotation_QuotationAdd" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        function GetMyValue(contrlname, myvalue) {
            ...
            document.getElementById("cs_txt").value = "";
    ...
    <form id="form1" runat="server">
        ...
        <fieldset>
            <legend style="color: Red">请选择联系人
                ...
                <input id="Button11" visible="false" runat="server" type="button" class="BnCss" value="开始报价" style="text-align: left" onclick="bianhao()" /><span style="font-size: medium; vertical-align: middle; color: red">*</span>

                <input id="Text50" visible="false" type="text" backcolor="#E0E0E0" bordercolor="#E0E0E0" runat="server" readonly="readonly" class="myline" style="width: 145px" />
                        ...
                        <asp:GridView ID="GridView1" runat="server" Width="100%" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="产品名称">
                                    <EditItemTemplate>
                                        <asp:TextBox ID="TextBoxcn" runat="server"
                                            Text='<%# Bind("name") %>' Width="100px" Wrap="true"></asp:TextBox>
                                    </EditItemTemplate>
                                    <ItemTemplate>
                                        <asp:Label ID="Labelcn" runat="server" Text='<%# Bind("name") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="产品型号">
                                    <EditItemTemplate>
                                        <asp:TextBox ID="TextBoxct" runat="server"
                                            Text='<%# Bind("type") %>' Width="100px" Wrap="true"></asp:TextBox>
                                    </EditItemTemplate>
                                    <ItemTemplate>
                                        <asp:Label ID="Labelct" runat="server" Text='<%# Bind("type") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="备注">
                                    <EditItemTemplate>
                                        <asp:TextBox ID="TextBoxcb" runat="server"
                                            Text='<%# Bind("beizhu") %>' Width="100px" Wrap="true"></asp:TextBox>
                                    </EditItemTemplate>
                                    <ItemTemplate>
                                        <asp:Label ID="Labelcb" runat="server" Text='<%# Bind("beizhu") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
        ...
        <fieldset>
            <legend style="color: Red">项目信息（必选,否则后续流程出错）</legend>
            <table class="Admin_Table">
                ...
                <tr>
                    <td align="center" colspan="4">
                        <asp:GridView ID="GridView2" runat="server" Width="100%" AutoGenerateColumns="False"
                            ...
                            OnRowEditing="GridView2_RowEditing" DataKeyNames="id"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="标准"
                                    ...
                                    <EditItemTemplate>
                                        <asp:TextBox ID="TextBox2" runat="server" Height="147px"
                                            Text='<%# Bind("biaozhun") %>' Width="100px" Wrap="true" TextMode="MultiLine"></asp:TextBox>
                                    </EditItemTemplate>
                                    <ItemTemplate>
                                        <asp:Label ID="Label4" runat="server" Text='<%# Bind("biaozhun") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                            ...
                            <EmptyDataTemplate>
                                <asp:Label ID="Label5" runat="server" ForeColor="Red" Text="暂时未有数据"></asp:Label>
                            </EmptyDataTemplate>
                            <HeaderStyle CssClass="Admin_Table_Title " />
                        </asp:GridView>
                    </td>
                ...
                <tr>
                    <td colspan="4" align="center">
                        ...
                        <asp:Button ID="Button10" runat="server" Text="增加测试项目" OnClick="Button1_Click" Visible="False" />
                        <input type="Button" id="ButtonDepAdd" style="display: none" onclick="GetMyValue('cs_txt', window.open('Default4.aspx?kehuid=<%=d%>    > ','window','dialogWidth = 1000px; DialogHeight = 600px; status: no; help: no; resizable: yes; dialogTop: 100px; edge: raised; '))"
                            value="添加" />
        ...
        <fieldset style="display: none;">
            ...
            <table class="Admin_Table">
                ...
                <tr>
                    <td>单价费用：
                        <asp:TextBox ID="txt_csprice" runat="server" Width="240px"></asp:TextBox></td>
                    <td>数&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 量：
                        <asp:TextBox ID="txt_num" runat="server" Width="240px" Style="height: 23px"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td>对应部门：
                ...
                <tr>
                    ...
                    <td>
                        <asp:DropDownList ID="drop_Waibu" runat="server" Width="240px">
                        </asp:DropDownList></td>
                </tr>
                <tr>
        ...
        <fieldset>
            ...
            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                <ContentTemplate>
                    <table class="Admin_Table">
                        <tr>
                            <td class="auto-style1">不含外包项目实际报价：
                    <asp:TextBox ID="weituo" runat="server" Visible="false" Width="31px"></asp:TextBox>
                            </td>
                            <td class="auto-style1">
                                <asp:TextBox ID="baojiazhehou_txt" runat="server" ReadOnly="true" BackColor="#E0E0E0" BorderColor="#E0E0E0" Enabled="false"></asp:TextBox>
                            </td>
                            <td class="auto-style1">报价备注：
                            </td>
                            <td class="auto-style1">
                        ...
                        <tr>
                            ...
                            <td>外包总金额：</td>
                            <td>
                                <asp:TextBox ID="TextBox_epibolypricetotal" runat="server" BackColor="#E0E0E0" BorderColor="#E0E0E0" Enabled="false"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td>含外包项目报价：</td>
                            <td>
                                <asp:TextBox ID="epiboly_price" runat="server" onfocus="this.blur()" BackColor="#E0E0E0" BorderColor="#E0E0E0" Enabled="false"></asp:TextBox></td>
                            <td>整单折扣</td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <asp:Label ID="lb_txt" runat="server" Style="color: Red" Text="输入优惠金额后鼠标点击该文本框外面将会自动计算折扣"></asp:Label>
                            </td>
                            <td>报价总金额：</td>
                            <td>
                        ...
                        <tr>
                            <td colspan="4">是否含税:
                                ...
                                &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp;
                                币种:
                                <asp:DropDownList ID="drop_currency" runat="server" AutoPostBack="True" OnSelectedIndexChanged="drop_currency_SelectedIndexChanged">
                        ...
                        <tr>
                            <td colspan="4">
                                ...
                                <br />
                                含扩展费的合同需部门经理审核、扩展费超过500元人民币则需要总经理审批</td>
                        </tr>
                    </table>
                </ContentTemplate>
            </asp:UpdatePanel>
        ...
        <fieldset>
            ...
            </asp:DropDownList>&nbsp;<asp:Label ID="Label6" runat="server" Text="如果做英文报价请选择英文条款" Style="color: Red"></asp:Label>
            <table class="Admin_Table">
                <tr>
                    <td>选择条款：
                    </td>
                ...
                <tr>
                    <td colspan="2" align="center">付款方式：<asp:DropDownList ID="drop_way" runat="server">
                        ...
                        首款金额：<asp:TextBox ID="txt_drow" runat="server" onkeyup='this.value=this.value.replace(/[^0-9.]/gi,"")'></asp:TextBox>
                        &nbsp;&nbsp;&nbsp;&nbsp;</td>
                </tr>
                <tr>
                    <td colspan="4" align="center">银行账户:<asp:DropDownList ID="DropDownList2" runat="server">
                    </asp:DropDownList>
                        <asp:Button ID="Button3" runat="server" Text="保存报价" OnClick="Button3_Click" />
                        <asp:Button ID="Button4" runat="server" Text="提至审批" Visible="false" OnClick="Button4_Click" />
                        <asp:Button ID="Button5" runat="server" Text="回签" Visible="false" OnClick="Button5_Click" />
                        <asp:Label ID="Label3" runat="server"></asp:Label><asp:Button ID="Button7" runat="server"
                            Text="填写委托信息" OnClick="Button7_Click" Visible="false" />
                        <asp:Button ID="Button8" runat="server" OnClick="Button8_Click" Visible="false" Text="填写委托信息" />
                        <asp:Button ID="Button9" runat="server" OnClick="Button9_Click" Text="上传附件" Visible="false" />



                        <asp:Button ID="Button12" runat="server" OnClientClick="javascript:alert('已复制成功,页面将进入新生成的报价单后请点击修改保存按钮')" OnClick="Button12_Click"
                            Text="复制报价单" Visible="False" />
